...
templates['direct-message-breadcrumb-template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.publicKey : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "				<br/>Not sure if "
    ...
    + ",true)\" value=\"send it\"/>  ("
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + " can't send you encryted messages until you have sent them your key)\r\n";
  ...
  return "				<br/>Your current public key is newer than the key you last sent to "
...
templates['direct-message-button-template.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['direct-message-friend-name.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;

  return "				<div class=\"breadCrumbSeparator\"><li class=\"fa fa-long-arrow-right\"></li></div>  with "
    + container.escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"name","hash":{},"data":data}) : helper)))
    + "\r\n";
},"useData":true});
})();(function() {
...
templates['direct-messages-template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "					<div class=\"container dmMessageDiv dm_"
    ...
    + "  \r\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.decryptionSuccessful : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.signed : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "								</span>\r\n								<div class=\"directMessage\">"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.decryptionSuccessful : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.program(8, data, 0),"data":data})) != null ? stack1 : "")
    + "</div>\r\n							</div>\r\n						</div>\r\n					</div>\r\n";
},"2":function(container,depth0,helpers,partials,data) {
...
templates['direct-message-template.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['hashes-not-found-template.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "		<h2 class=\"timeLine\">File hashes</h2>\r\n		<br/><br/>\r\n		<span style=\"color:red;font-size:1.5em\">WARNING</span>: \r\n		<div style=\"font-weight:bold;font-size:1.5em;display:inline;\">UNABLE to load or process the file hashes.txt</div>\r\n		<p/><br/><br/>\r\n		This means that something is wrong with this installation of Seecret.  If you are on a Seecret mirror site, the contents may have been compromised.  If you are seeing this from the version of Seecret hosted at <a href=\"https://www.seecret.io\" target=\"_new\">www.seecret.io</a> something is SERIOUSLY WRONG.  Do not use this app.<p/><br/>\r\n		<p/>\r\n		Read more at <a href=\"https://www.seecret.net\" target=\"_new\">https://www.seecret.net</a> to learn about Seecret mirror sites and how to validate them.";
},"useData":true});
})();(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['hashes-template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<li style=\"margin:12px;\"> - SHA1 hash for <a href=\""
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "\" target=\"_new\">"
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
  ...
  return "		<h2 class=\"timeLine\">File hashes</h2>\r\n		<br/>\r\n		You are using Seecret version 1.0\r\n		<br/><br/>\r\n		<div style=\"font-weight:bold;font-size:1.3em\">If you are using the direct messages feature in Seecret, please pay close attention to the following information</div>\r\n		<p/><br/>\r\n			You can verify the integrity of the major components of this application with the SHA1 values listed below.  You should see 11 (ELEVEN) files listed.  You can also follow <a href=\"https://twitter.com/seecretapp\" target=\"_new\">Seecret on Twitter</a> for any news about compromised Seecret mirrors.  Read more at <a href=\"https://www.seecret.net/mirror.html\" target=\"_new\">https://www.seecret.net/mirror.html</a><p/><br/>\r\n		<ol style=\"list-style-type: decimal;padding-left:20px;\">\r\n"
...
templates['no-more-timeline-message-template.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['no-seecrets-in-direct-messages-template.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div style=\"font-weight:bold\">There were no Seecrets found in the last 200 direct messages.</div>";
},"useData":true});
})();(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
...
templates['status-template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "								<div class=\"originalMessage\">\r\n"
