...
"function"===typeof d?d.call(a,{name:"id_str",hash:{},data:e}):d))+'\',this.id)" id="friendMessagesToggleLink_'+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"id_str",hash:{},data:e}):d))+'">show conversation</a>\r\n'},2:function(f,a,c,g,e){var b;return'\t\t\t\t\t\x3c!-- <img src="https://cdn.rawgit.com/simpledynamics/seecret_app/e449e723f317fce6866a09c016d36acddaaac9d6/src/main/resources/public/img/new-icon.png" class="dmIconNew" alt="New" title="New" /> --\x3e\r\n\t\t\t\t\t<i class="fa fa-comments msgCount'+
f.escapeExpression((b=null!=(b=c.newMessageCount||(null!=a?a.newMessageCount:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"newMessageCount",hash:{},data:e}):b))+'" aria-hidden="true" style="font-size:1.5em" id="newMessagesStatus_'+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+'"></i>\r\n\t\t\t\t\t\r\n'},4:function(f,a,c,g,e){var b;return'\t\t\t\t<br/><span class="undecryptedMessagesInfo">Some messages from '+
f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+' could not be decrypted. Read the <a href="https://www.seecret.net/faq.html" target="_new">FAQ</a> to understand more.</span>\r\n'},6:function(f,a,c,g,e){var b;return"\t\t\tNo Seecret messages from "+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",
hash:{},data:e}):b))+" \r\n"},8:function(f,a,c,g,e){var b;return null!=(b=c.unless.call(a,null!=a?a.publicKey:a,{name:"unless",hash:{},fn:f.program(9,e,0),inverse:f.noop,data:e}))?b:""},9:function(f,a,c,g,e){var b;return'\t\t\t\t\x3c!-- user has sent their key to this follower but has not received a public key in return.  TODO:  make this a key request --\x3e\r\n\t\t\t\t<input type=button value="Invite '+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===
typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+'" onClick="app.keyRequest('+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+')"/>\r\n\t\t\t\t(You may be seeing this because you are using a new mirror site or a different device.  Read more in the <a href="https://www.seecret.net/faq.html" target="_new">FAQ</a>) \r\n'},11:function(f,a,c,g,e){var b;return null!=(b=c["if"].call(a,null!=a?a.publicKey:
a,{name:"if",hash:{},fn:f.program(12,e,0),inverse:f.program(14,e,0),data:e}))?b:""},12:function(f,a,c,g,e){var b;return"\t\t\t\t\x3c!-- user has received this follower's public key but has not sent their own public key in response --\x3e\r\n\t\t\t\t<br/>"+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+' wants to message you with Seecret.  <input type=button value="Allow" onClick="app.invite('+
...
a).append(Handlebars.getTemplate("direct-messages-template")(c))},getFriendsFromMessageList:function(a){var b={},c;for(c in a)b[a[c].sender.screen_name]||(b[a[c].sender.screen_name]=a[c].sender,b[a[c].sender.screen_name].most_recent=a[c],console.log("Most recent message from "+a[c].sender.screen_name+" is "+a[c].created_at)),b[a[c].sender.screen_name].message_count||(b[a[c].sender.screen_name].message_count=0),b[a[c].sender.screen_name].message_count++;a=[];for(f in b)a.push(b[f]);return a},toggleFriendMessages:function(a){"show conversation"!=
$("#friendMessagesToggleLink_"+a).html()?(console.log("updating conversation link to say 'show conversation'"),$("#friendMessagesToggleLink_"+a).html("show conversation"),console.log("hiding friendMessagesForm_"+a),$("#friendMessageForm_"+a).fadeOut(),console.log("hiding friendMessages_"+a),$("#friendMessages_"+a).fadeOut()):($("#friendMessagesToggleLink_"+a).html("hide conversation"),$("#friendMessageForm_"+a).fadeIn(),$("#friendMessages_"+a).fadeIn())},filterMessageListByFriendId:function(a,b){var c=
[],d;for(d in a)a[d].sender.id_str!=b&&a[d].sender.id_str!=app.activeUser.id_str||c.push(a[d]);console.log("filtered "+a.length+" down to "+c.length);return c},getOlderDirectMessages:function(){app.hasFirstDirectMessage||(app.setupDMPostData(),app.dmPostData.max_id=app.dmMaxId,app.doDMPost(app.dmPostData,function(a){if(a.length<app.NUM_DM||app.dmMaxId==a[a.length-1].id_str)app.hasFirstDirectMessage=!0,$("#directMessages").append(Handlebars.getTemplate("no-more-direct-messages-template")()),$("#getOlderMessagesButton").hide();
...
console.log(JSON.stringify(a))}))},generatePrivateKeyPairSuccess:function(a,b,c,d){c||delete b.passphrase;c=app.activeUser.user;var e=new Date,g={};g.armored=a.privateKeyArmored;g.dateCreated=e;var h={};h.armored=a.publicKeyArmored;h.dateCreated=e;app.saveObject("keyOptions-"+c.id_str,b);app.saveObject("privateKey-"+c.id_str,g);app.saveObject("publicKey-"+c.id_str,h);app.checkDirectMessageStatus();app.refreshActiveUserTotal();d()},showAllDirectMessages:function(){$(".friendMessages").show()},invite:function(a,
b){var c=app.generatePublicKeyMessages(a),d=[],e;for(e in c)d.push({receiverId:a,text:c[e]});b||d.push({text:app.joinMessage,receiverId:a});app.overlay();app.postDirectMessages(d,function(){var b={};b[a]=!0;app.trackSentPublicKeys(b);$("#friendKeyContainer_"+a).html("Invite sent.")})},prepareDirectMessage:function(a){if(!app.sendingDirectMessage){var b=$("#directMessage_"+a).val();0!=b.length&&($("#directMessage_"+a).val(""),app.sendingDirectMessage=!0,app.overlay(),app.encryptDirectMessage(b,a))}},
decryptPrivateKey:function(a){var b=app.activeUser.keyOptions,c=null;app.passphrase&&(c=app.passphrase);b.passphrase&&(c=b.passphrase);b.passphrase||null!=app.passphrase||(app.passphrase=c=prompt("Enter your passphrase"));if(a.decrypt(c))return!0;app.passphrase=null;return!1},encryptDirectMessage:function(a,b){var c=app.activeUser.publicKeys,d=null,e;for(e in c)e==b&&(d=c[e].key);d?(c=openpgp.key.readArmored(d).keys,c={publicKeys:c,data:a},app.activeUser.privateKey&&(d=openpgp.key.readArmored(app.activeUser.privateKey.armored),
app.decryptPrivateKey(d.keys[0])&&(c.privateKeys=d.keys)),openpgp.encrypt(c).then(function(a){a=app.hideAndCompress(a.data);app.seecret_engine.config.RANDOM_COVERTEXTS=!0;app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=1E4;a=app.seecret_engine.chainify(a,covertexts);app.seecret_engine.config.RANDOM_COVERTEXTS=!1;app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=140;a.reverse();for(var c in a)a[c]={receiverId:b,text:a[c]};app.postDirectMessages(a,function(){});$("#directMessage").val("")}).catch(function(a){console.log("Error generating the messages:"+
JSON.stringify(a));app.hideOverlays();app.sendingDirectMessage=!1})):(app.sendingDirectMessage=!1,app.hideOverlays(),alert("You do not have that users public key."))},postDirectMessages:function(a,b){app.overlay();app.directMessagesToPost=a;app.directMessageCount=0;app.checkDirectMessages(b)},checkDirectMessages:function(a){if(app.directMessagesToPost&&app.directMessageCount<app.directMessagesToPost.length){var b=app.directMessagesToPost[app.directMessageCount].text,c=app.directMessagesToPost[app.directMessageCount].receiverId;
...
return c},getUniqueTweeters:function(a){return app.getUniqueInstancesFromList(a,app.getTweeterId)},getUniqueDMSenders:function(a){return app.getUniqueInstancesFromList(a,app.getDMSenderId)},getTweeterId:function(a){return a.user.id_str},getDMSenderId:function(a){return a.sender.id_str},getUniqueInstancesFromList:function(a,b){console.log("getting unique instances");var c={},d;for(d in a){var e=b(a[d]);e&&(c[e]=e)}return c},generateTimelinePostVals:function(){var a={data:{}};a.data.count=200;null!=
app.maxId&&(a.data.max_id=app.maxId);return a},initTimeline:function(){app.maxId=null;app.homeTimeline=!0;app.userTimelineId=null;app.updateHomeTimeline()},updateHomeTimeline:function(a){$("#twitterUser").val("");a&&(app.maxId=null);app.homeTimeline=!0;$("#timelineName").empty();app.updatingTimeline=!0;a=app.generateTimelinePostVals();a.data.max_id||($("#status-list").empty(),app.lastProcessedStatusId=null);app.overlay();app.timer("Get timeline");app.getTimeline(a,app.handleTimelineResponse)},prepareUpdateMessage:function(){var a=
$("#textarea-statusUpdate").val(),a=app.hideAndCompress(a),b=null;app.useAutogeneratedScaffolding()||(b=app.getScaffolds());a=app.seecret_engine.chainify(a,b);a.reverse();return a},updateStatus:function(){var a=this.prepareUpdateMessage();this.postChain(a)},postChain:function(a){this.currentMessageChain=a;this.chainCount=0;this.postChainItem()},postChainItem:function(){this.chainCount<this.currentMessageChain.length?app.oauthResult.post("1.1/statuses/update.json",{data:{status:this.currentMessageChain[this.chainCount++]}}).done(function(a){setTimeout(function(){app.postChainItem()},
50)}).fail(function(a){}):($("#status-list").empty(),$("#scaffoldingWarningContainer").empty(),$("#scaffoldingStatus").empty(),$("#textarea-statusUpdate").val(""),$("#textarea-statusUpdate").val(""),$("#scaffoldsContainer").html(Handlebars.getTemplate("scaffolds-template")()),$("#scaffoldingContainer > div > div > input").val(""),app.maxId=null,this.currentMessageChain=[],this.chainCount=0,app.updateHomeTimeline(),app.setView(app.TIMELINE_VIEW))},authenticatedUI:function(){app.authenticatedHeader();
app.authenticatedMenu();app.setView(app.TIMELINE_VIEW)},unauthenticatedUI:function(){$("#status-list").empty();$("#userLabel").empty();$("#userProfileImg").hide();$("#directMessages").empty();$("#publicKeys").empty();$("#directMessagesActionsContainer").val("");$("#textarea-statusUpdate").val("");$("#importPrivateKeyText").val("");$("#importPrivateKeyPassphrase").val("");$("#privateKeyTextarea").val("");$("#privateKeyPassphrase").val("");$("#privateKeyCopyarea").empty();$("#publicKeysDisplayArea").empty();
app.unauthenticatedHeader();$("#privateMessagesButton").hide();$("#timelineButton").hide();app.unauthenticatedMenu();app.setView(app.ABOUT_VIEW)},authenticatedMenu:function(){$("#privateMessagesButton").show();$("#timelineButton").show();$("#settingsButton").show();$("#logoutButton").show();$("#hashesButton").show();$("#publicKeysButton").show();$("#aboutButton").show()},unauthenticatedMenu:function(){$("#privateMessagesButton").hide();$("#timelineButton").hide();$("#settingsButton").hide();$("#logoutButton").hide();
$("#publicKeysButton").hide()},authenticatedHeader:function(){app.activeUser&&app.activeUser.user&&(console.log("app.active user = "+JSON.stringify(app.activeUser.user)),app.activeUser.user.profile_image_url=app.activeUser.user.profile_image_url.replace(app.httpsReplaceRegex,"https:"),$("#loginContainer").html(Handlebars.getTemplate("authenticated-header-template")(app.activeUser.user)))},unauthenticatedHeader:function(){$("#loginContainer").html(Handlebars.getTemplate("unauthenticated-header-template")())},
