...
(function(){var h=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["friends-list-template"]=h({compiler:[7,">= 4.0.0"],main:function(e,a,d,g,f){var b;return(null!=(b=d.blockHelperMissing.call(a,e.lambda(a,a),{name:".",hash:{},fn:e.program(1,f,0),inverse:e.noop,data:f}))?b:"")+"\r\n\r\n"},1:function(e,a,d,g,f){var b,c;return'\t<div class="friendDetailsContainer" id="friendDetails_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?
c.call(a,{name:"id_str",hash:{},data:f}):c))+'" class="friendDetails">\r\n\t\t<img src="'+e.escapeExpression((c=null!=(c=d.profile_image_url||(null!=a?a.profile_image_url:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"profile_image_url",hash:{},data:f}):c))+'" /><strong>'+e.escapeExpression((c=null!=(c=d.screen_name||(null!=a?a.screen_name:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"screen_name",hash:{},data:f}):c))+'</strong> <span id="messageCount_'+e.escapeExpression((c=
null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'">'+e.escapeExpression((c=null!=(c=d.message_count||(null!=a?a.message_count:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"message_count",hash:{},data:f}):c))+" messages </span> <a href=\"javascript:app.toggleFriendMessages('"+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},
data:f}):c))+'\',this.id)" id="friendMessagesToggleLink_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'">show conversation</a> \r\n\t\t'+e.escapeExpression((d.tweetShortDate||a&&a.tweetShortDate||d.helperMissing).call(a,null!=(b=null!=a?a.most_recent:a)?b.created_at:b,{name:"tweetShortDate",hash:{},data:f}))+"  "+(null!=(b=d["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:e.program(2,f,
0),inverse:e.noop,data:f}))?b:"")+'\r\n\t\t<div id="friendPublicKeyDetails_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'">\r\n'+(null!=(b=d["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:e.program(4,f,0),inverse:e.noop,data:f}))?b:"")+'\t\t<div id="friendKeyContainer_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",
hash:{},data:f}):c))+'">'+(null!=(b=d.unless.call(a,null!=a?a.sentKey:a,{name:"unless",hash:{},fn:e.program(6,f,0),inverse:e.noop,data:f}))?b:"")+'</div>\r\n\t\t<br/>\r\n\t\t<div id="friendMessages_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'" style="display:none" class="friendMessages"></div>\r\n\t</div>\r\n'},2:function(e,a,d,g,f){var b;return"<a href=\"javascript:app.openDirectMessageForm('"+
e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+"')\">Send message</a>"},4:function(e,a,d,g,f){var b;return'\t\t\t<div id="friendMessageForm_'+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'" style="display:none">\r\n\t\t\t<br/>\r\n\t\t\t<textarea id="directMessage_'+e.escapeExpression((b=null!=(b=
d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'" style="width:50%"></textarea>\r\n\t\t\t<input type=button onClick="app.prepareDirectMessage(\''+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'\')" value="Send message" class="button"/>\r\n\t\t\t<br/>Not sure if '+e.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:
a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:f}):b))+' has your public key?  <input type=button class="button" onClick="app.initiateDirectMessages('+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+',true)" value="Send it"/><br/>\r\n\t\t\t</div>\r\n'},6:function(e,a,d,g,f){var b;return"\r\n\t\t\tDo you want to invite "+e.escapeExpression((b=null!=(b=d.receiver_name||
(null!=a?a.receiver_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"receiver_name",hash:{},data:f}):b))+' to use Seecret with you?\r\n\t\t\t<input type=button class="button" value="YES" onClick="app.initiateDirectMessages('+e.escapeExpression((b=null!=(b=d.receiver_id||(null!=a?a.receiver_id:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"receiver_id",hash:{},data:f}):b))+')"/>.  \r\n\t\t\t<br/>'+e.escapeExpression((b=null!=(b=d.receiver_name||(null!=a?a.receiver_name:
a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"receiver_name",hash:{},data:f}):b))+" will receive an invite message and a Seecret key that will allow you to exchange encrypted messages.\r\n\t\t"},useData:!0})})();
...
useData:!0})})();
(function(){var f=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["public-keys-template"]=f({compiler:[7,">= 4.0.0"],main:function(d,b,c,f,e){var a;return null!=(a=c.each.call(b,null!=b?b.keys:b,{name:"each",hash:{},fn:d.program(1,e,0),inverse:d.noop,data:e}))?a:""},1:function(d,b,c,f,e){var a;return'\t\t\t\t<div class="keyDisplayContainer">\r\n\t\t\t\t\t<br/><br/>\r\n\t\t\t\t\tFrom <a href="javascript:app.initializeDirectMessageView()">'+d.escapeExpression((a=null!=(a=c.screen_name||
(null!=b?b.screen_name:b))?a:c.helperMissing,"function"===typeof a?a.call(b,{name:"screen_name",hash:{},data:e}):a))+"</a> sent on "+d.escapeExpression((a=null!=(a=c.displayDate||(null!=b?b.displayDate:b))?a:c.helperMissing,"function"===typeof a?a.call(b,{name:"displayDate",hash:{},data:e}):a))+'.\r\n\t\t\t\t\t<pre class="keyDisplay" id="keyDisplay_'+d.escapeExpression((a=null!=(a=c.id_str||(null!=b?b.id_str:b))?a:c.helperMissing,"function"===typeof a?a.call(b,{name:"id_str",hash:{},data:e}):a))+
'">'+d.escapeExpression((a=null!=(a=c.key||(null!=b?b.key:b))?a:c.helperMissing,"function"===typeof a?a.call(b,{name:"key",hash:{},data:e}):a))+"</pre>\r\n\t\t\t\t\t<br/>\r\n\t\t\t\t\t<button onClick=\"app.copySenderPublicKeyToClipboard('"+d.escapeExpression((a=null!=(a=c.id_str||(null!=b?b.id_str:b))?a:c.helperMissing,"function"===typeof a?a.call(b,{name:"id_str",hash:{},data:e}):a))+"')\">Copy to clipboard</button>\r\n\t\t\t\t</div>\r\n\t\t\t\t<br/><br/>\r\n"},useData:!0})})();
...
app.getObject("dmSenders-"+app.activeUser.user.id_str);app.activeUser.dmSenders=a},initialize:function(){location.hash&&history.pushState("",document.title,window.location.pathname+window.location.search);app.unauthenticatedUI();app.initOauth()},loginToTwitter:function(){OAuth.popup("twitter",{options:{cache:!0}}).done(function(a){console.log("oauth done!");app.oauthResult=a;app.saveOauth();app.updateOauthUserInfo()}).fail(function(a){console.log(JSON.stringify(a));alert("Error logging into Twitter.  Please try again");
app.unauthenticatedUI()})},logoutFromTwitter:function(){app.oauthResult=null;app.lastProcessedStatusId=null;app.lastProcessedMessageId=null;app.dmMaxId=null;app.postedDirectMessageId=null;app.directMessagesToPost=null;app.directMessageCount=null;app.maxId=null;app.activeUser={};app.lastId=null;app.password=null;app.postCompleteCount=0;app.postCompleteTarget=0;app.deleteSavedItem("user");localStorage.removeItem("oauth_token");localStorage.removeItem("oauth_token_secret");app.hideAllViews();app.unauthenticatedUI()},
initOauth:function(){null==app.oauthResult&&OAuth.initialize(oauthio_key.key);app.loadOauth();app.updateOauthUserInfo()},saveOauth:function(){localStorage.setItem("oauth_token",app.oauthResult.oauth_token);localStorage.setItem("oauth_token_secret",app.oauthResult.oauth_token_secret)},loadOauth:function(){var a=localStorage.getItem("oauth_token"),b=localStorage.getItem("oauth_token_secret");if(null==a||null==b)return null;app.oauthResult=OAuth.create("twitter",{oauth_token:a,oauth_token_secret:b})},
updateOathUserInfoComplete:function(a){null!=app.activeUser&&null!=app.activeUser.user&&null!=app.activeUser.user.id_str&&null==app.activeUser.privateKey?(app.hideAllViews(),$("#"+app.STATUS_MESSAGE_VIEW).show(),app.generatePrivateKeyPair(app.generatePassword(),!0,function(){app.updateUIBasedUponOauthResult()})):app.updateUIBasedUponOauthResult()},updateOauthUserInfo:function(){null!=app.oauthResult?app.oauthResult.me().done(function(a){app.activeUser.user=a.raw;app.refreshActiveUserTotal();app.updateOathUserInfoComplete(a)}).fail(function(a){alert("There was an error logging you into Twitter.  Please reload the page and try again.")}):
app.updateOathUserInfoComplete()},updateUIBasedUponOauthResult:function(){null!=app.oauthResult?(app.authenticatedUI(),app.maxId=null,app.updateHomeTimeline()):app.unauthenticatedUI()},initializeDirectMessagesView:function(){app.setView(app.DIRECT_MESSAGES_VIEW);""==$("#directMessages").html()?app.startDirectMessages():app.getNewestDirectMessages()},getNewestDirectMessages:function(){app.setupDMPostData();app.dmSinceId?(app.dmPostData.since_id=app.dmSinceId,app.overlay(),app.doDMPost(app.dmPostData,
app.handleDMResponse)):console.log("getting newest but there's no since id?  ")},setupDMPostData:function(){app.dmPostData={count:app.NUM_DM,full_text:!0,include_entities:!1,skip_status:!0}},startDirectMessages:function(){app.setupDMPostData();app.overlay();app.doDMPost(app.dmPostData,app.handleDMResponse)},doDMPost:function(a,b){app.updatingDirectMessages=!0;app.oauthResult.get("1.1/direct_messages.json",{data:a}).done(function(a){0<a.length?($("#getOlderMessagesButton").show(),app.dmSinceId||(app.dmSinceId=
a[0].id_str),b(a)):(app.hideOverlays(),app.dmPostData.since_id?alert("No new direct messages"):app.dmPostData.max_id||$("#directMessages").html("You have no direct messages."))}).fail(function(a){app.hideOverlays()})},handleDMResponse:function(a){var b=null!=app.dmPostData.since_id;if(b&&0==a.length)alert("No new messages");else{$(".friendMessages").hide();console.log("handling dm response for "+a.length);if(1==a.length&&a[0].id_str==app.dmMaxId)app.hasFirstDirectMessage||($("#directMessages").append(Handlebars.getTemplate("no-more-direct-messages-template")()),
$("#getOlderMessagesButton").hide()),app.hasFirstDirectMessage=!0,app.hideOverlays(),app.updatingDirectMessages=!1;else if(0==a.length)$("#directMessages").append(Handlebars.getTemplate("no-seecrets-in-direct-messages-template")()),app.hideOverlays(),app.updatingDirectMessages=!1;else{var c=app.processMessageList(a,"sender","dmMaxId");app.timelineContainsKeys(c)&&(console.log("saving public keys!"),app.savePublicKeys(app.getPublicKeyMessagesFromDMList(c)));var d=app.getFriendsFromMessageList(c);app.markMessageableFriends(d);
app.markFriendsWithSentKeys(d);console.log("Found "+d.length+" friends");if($("#friendsContainer").is(":empty"))$("#friendsContainer").html(Handlebars.getTemplate("friends-list-template")(d));else{var e=[],g;for(g in d)null==document.getElementById("friendDetails_"+d[g].id_str)&&e.push(d[g]);0<e.length?$("#friendsContainer").prepend(Handlebars.getTemplate("friends-list-template")(e)):console.log("no new friends")}if(b){b="New messages from ";e="";for(g in d)b+=e+d[g].screen_name,e=",";0<a.length&&
alert(b)}app.timelineContainsEncryptedMessages(c)&&app.markEncryptedDirectMessages(c);app.updateDirectMessagesUI(c,d)}app.hideOverlays()}},updateDirectMessagesUI:function(a,b){app.hideOverlays();b=b?b:app.getFriendsFromMessageList(a);app.renderAllFriendMessages(b,a);app.updatingDirectMessages=!1},markMessageableFriends:function(a){var b=app.getObject("publicKeys-"+app.activeUser.user.id_str),c;for(c in a)console.log("the public key is "+b[a[c].id_str]),a[c].publicKey=b[a[c].id_str]},markFriendsWithSentKeys:function(a){console.log("marking friends with sent keys!");
var b=app.getObject("sentPublicKeys-"+app.activeUser.user.id_str),c;for(c in b)for(var d in a)c==a[d].id_str&&(a[d].sentKey=b[c])},renderAllFriendMessages:function(a,b){for(var c in a)app.renderFriendMessages(a[c].id_str,b)},renderFriendMessages:function(a,b){var c=app.filterMessageListByFriendId(b,a);app.dmPostData.sinceId?$("#friendMessages_"+a).prepend(Handlebars.getTemplate("direct-messages-template")(c)):$("#friendMessages_"+a).append(Handlebars.getTemplate("direct-messages-template")(c))},getFriendsFromMessageList:function(a){var b=
{},c;for(c in a)b[a[c].sender.screen_name]||(b[a[c].sender.screen_name]=a[c].sender,b[a[c].sender.screen_name].most_recent=a[c],console.log("Most recent message from "+a[c].sender.screen_name+" is "+a[c].created_at)),b[a[c].sender.screen_name].message_count||(b[a[c].sender.screen_name].message_count=0),b[a[c].sender.screen_name].message_count++;a=[];for(f in b)a.push(b[f]);return a},toggleFriendMessages:function(a){"show conversation"!=$("#friendMessagesToggleLink_"+a).html()?($("#friendMessagesToggleLink_"+
a).html("show conversation"),$("#friendMessages_"+a).fadeOut()):($("#friendMessagesToggleLink_"+a).html("hide"),$("#friendMessages_"+a).fadeIn())},filterMessageListByFriendId:function(a,b){var c=[],d;for(d in a)a[d].sender.id_str!=b&&a[d].sender.id_str!=app.activeUser.id_str||c.push(a[d]);console.log("filtered "+a.length+" down to "+c.length);return c},getOlderDirectMessages:function(){app.hasFirstDirectMessage||(app.setupDMPostData(),app.dmPostData.max_id=app.dmMaxId,app.doDMPost(app.dmPostData,
function(a){if(a.length<app.NUM_DM||app.dmMaxId==a[a.length-1].id_str)app.hasFirstDirectMessage=!0,$("#directMessages").append(Handlebars.getTemplate("no-more-direct-messages-template")()),$("#getOlderMessagesButton").hide();app.handleDMResponse(a)}))},isPublicKey:function(a){return app.publicKeyStartRegex.test(a)&&app.publicKeyEndRegex.test(a)},isPGPMessage:function(a){return app.pgpMessageStartRegex.test(a)&&app.pgpMessageEndRegex.test(a)},timelineContainsKeys:function(a){for(var b in a)if(app.isPublicKey(a[b].seecret))return!0;
...
app.activeUser.sentPublicKeys;null==b&&(b={});for(var c in a)b[c]=new Date;app.activeUser.sentPublicKeys=b;app.saveObject("sentPublicKeys-"+app.activeUser.user.id_str,b)},decryptDirectMessages:function(a){var b=openpgp.key.readArmored(app.activeUser.privateKey.armored).keys[0];if(app.decryptPrivateKey(b))app.verifyMessagesDecrypted(a,b);else{alert("Could not verify your passphrase.  Showing messages undecrypted.");for(var c in a)a[c].encrypted&&(a[c].text+=" (could not decrypt)");app.updateDirectMessagesUI(a)}},
verifyMessagesDecrypted:function(a,b){var c=null,d;for(d in a)if(a[d].encrypted&&0==a[d].decrypted){c=d;break}var e=app.activeUser.user;if(null!=c)if(a[c].sender.id_str==e.id)a[c].decrypted=!0,app.verifyMessagesDecrypted(a,b);else{a[c].decrypted=!0;a[c].decryptionSuccessful=!1;a[c].originaltext=a[c].text;try{var g=openpgp.message.readArmored(a[c].seecret),h={privateKey:b,message:g};if(app.activeUser.publicKeys&&app.activeUser.publicKeys[a[c].sender.id_str]){var k=openpgp.key.readArmored(app.activeUser.publicKeys[a[c].sender.id_str].key);
...
console.log(JSON.stringify(a))}))},generatePrivateKeyPairSuccess:function(a,b,c,d){c||delete b.passphrase;c=app.activeUser.user;var e=new Date,g={};g.armored=a.privateKeyArmored;g.dateCreated=e;var h={};h.armored=a.publicKeyArmored;h.dateCreated=e;app.saveObject("keyOptions-"+c.id_str,b);app.saveObject("privateKey-"+c.id_str,g);app.saveObject("publicKey-"+c.id_str,h);app.checkDirectMessageStatus();app.refreshActiveUserTotal();d()},showAllDirectMessages:function(){$(".friendMessages").show()},initiateDirectMessages:function(a,
b){var c=app.generatePublicKeyMessages(a),d=[],e;for(e in c)d.push({receiverId:a,text:c[e]});b||d.push({text:app.joinMessage,receiverId:a});app.postDirectMessages(d,function(){var b={};b[a]=!0;app.trackSentPublicKeys(b)})},prepareDirectMessage:function(a){if(!app.sendingDirectMessage){var b=$("#directMessage_"+a).val();0!=b.length&&($("#directMessage_"+a).val(""),app.sendingDirectMessage=!0,app.overlay(),app.encryptDirectMessage(b,a))}},decryptPrivateKey:function(a){var b=app.activeUser.keyOptions,
...
JSON.stringify(a));app.hideOverlays();app.sendingDirectMessage=!1})):(app.sendingDirectMessage=!1,app.hideOverlays(),alert("You do not have that users public key."))},postDirectMessages:function(a,b){app.directMessagesToPost=a;app.directMessageCount=0;app.checkDirectMessages(b)},checkDirectMessages:function(a){if(app.directMessagesToPost&&app.directMessageCount<app.directMessagesToPost.length){var b=app.directMessagesToPost[app.directMessageCount].text,c=app.directMessagesToPost[app.directMessageCount].receiverId;
app.directMessageCount++;app.postDirectMessage(b,c,a)}else app.hideOverlays(),alert("Sent!"),app.sendingDirectMessage=!1,a&&a()},postDirectMessage:function(a,b,c){app.oauthResult.post("1.1/direct_messages/new.json",{data:{text:a,user_id:b}}).done(function(a){app.checkDirectMessages(c)}).fail(function(a){})},generatePublicKeyMessages:function(a){a=app.activeUser.publicKey;if(null!=a)return a=app.hideAndCompress(a.armored),app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=1E4,chain=app.seecret_engine.chainify(a,
["Here's my Seecret key","Now we can start using Seecret to send encrypted messages on Twitter."]),chain.reverse(),app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=140,chain},promptDeleteKey:function(){confirm("Are you sure?")&&(app.deleteSavedItem("privateKey-"+app.activeUser.user.id_str),app.deleteSavedItem("publicKey-"+app.activeUser.user.id_str),app.deleteSavedItem("keyOptions-"+app.activeUser.user.id_str),app.activeUser.privateKey=null,app.activeUser.publicKey=null,app.activeUser.keyOptions=
null,app.renderPrivateKeySettings(),app.setView(app.SETTINGS_VIEW))},openDirectMessageForm:function(a){$("#friendMessageForm_"+a).fadeIn()},checkDirectMessageStatus:function(){app.doScroll=!1;var a=$("#selectedReceiverId").val(),b=$("#selectedReceiverName").val();if(a)if(null==app.activeUser.privateKey)app.showPrivateKeyManager();else{var c=app.activeUser.publicKeys,d=app.activeUser.sentPublicKeys;null==d||null==d[a]||null!=c&&c[a]?null==c||null!=c&&!c[a]?app.showPublicKeyManager(a,b):app.showDirectMessageForm(a,
b):app.showWaitingForPublicKeyView(a,b);app.doScroll=!0}},updateUserTimeline:function(a,b){b&&(app.maxId=null);app.userTimelineId=a;app.homeTimeline=!1;app.updatingTimeline=!0;var c={data:{}};c.data.count=200;c.data.screen_name=a;c.data.include_rts=!1;null!=app.maxId?c.data.max_id=app.maxId:$("#status-list").empty();app.hideOverlays();app.getUserTimeline(c,app.handleTimelineResponse)},getTimeline:function(a,b){app.oauthResult.get("1.1/statuses/home_timeline.json",a).done(function(a){b(a);app.hideOverlays()}).fail(app.handleGetTimelineError)},
getUserTimeline:function(a,b){$("#twitterUser").val("");app.oauthResult.get("1.1/statuses/user_timeline.json",a).done(function(a){b(a);app.hideOverlays()}).fail(app.handleGetTimelineError)},handleTimelineResponse:function(a){0<a.length?1==a.length&&a[0].id_str==app.maxId?($("#status-list").append(Handlebars.getTemplate("no-more-timeline-message-template")()),$("#getOlderTimelineButton").hide()):app.processTimelineResponse(a):app.handleEmptyTimelineResponse(a)},handleGetTimelineError:function(a){429==
...
a&&(app.maxId=null);app.homeTimeline=!0;$("#timelineName").empty();app.updatingTimeline=!0;a=app.generateTimelinePostVals();a.data.max_id||($("#status-list").empty(),app.lastProcessedStatusId=null);app.overlay();app.getTimeline(a,app.handleTimelineResponse)},prepareUpdateMessage:function(){var a=$("#textarea-statusUpdate").val(),a=app.hideAndCompress(a),b=null;app.useAutogeneratedScaffolding()||(b=app.getScaffolds());a=app.seecret_engine.chainify(a,b);a.reverse();return a},updateStatus:function(){var a=
this.prepareUpdateMessage();this.postChain(a)},postChain:function(a){this.currentMessageChain=a;this.chainCount=0;this.postChainItem()},postChainItem:function(){this.chainCount<this.currentMessageChain.length?app.oauthResult.post("1.1/statuses/update.json",{data:{status:this.currentMessageChain[this.chainCount++]}}).done(function(a){setTimeout(function(){app.postChainItem()},50)}).fail(function(a){}):($("#status-list").empty(),$("#scaffoldingWarningContainer").empty(),$("#scaffoldingStatus").empty(),
$("#textarea-statusUpdate").val(""),$("#textarea-statusUpdate").val(""),$("#scaffoldsContainer").html(Handlebars.getTemplate("scaffolds-template")()),$("#scaffoldingContainer > div > div > input").val(""),app.maxId=null,this.currentMessageChain=[],this.chainCount=0,app.updateHomeTimeline(),app.setView(app.TIMELINE_VIEW))},authenticatedUI:function(){app.authenticatedHeader();app.authenticatedMenu();app.setView(app.TIMELINE_VIEW)},unauthenticatedUI:function(){$("#status-list").empty();$("#userLabel").empty();
$("#userProfileImg").hide();$("#directMessages").empty();$("#publicKeys").empty();$("#directMessagesActionsContainer").val("");$("#textarea-statusUpdate").val("");$("#importPrivateKeyText").val("");$("#importPrivateKeyPassphrase").val("");$("#privateKeyTextarea").val("");$("#privateKeyPassphrase").val("");$("#privateKeyCopyarea").empty();$("#publicKeysDisplayArea").empty();app.unauthenticatedHeader();$("#privateMessageButton").hide();$("#timelineButton").hide();app.unauthenticatedMenu();app.setView(app.ABOUT_VIEW)},
authenticatedMenu:function(){$("#privateMessageButton").show();$("#timelineButton").show();$("#settingsButton").show();$("#logoutButton").show();$("#hashesButton").show();$("#publicKeysButton").show();$("#aboutButton").show()},unauthenticatedMenu:function(){$("#privateMessageButton").hide();$("#timelineButton").hide();$("#settingsButton").hide();$("#logoutButton").hide();$("#publicKeysButton").hide()},authenticatedHeader:function(){app.activeUser&&app.activeUser.user&&(app.activeUser.user.profile_image_url=
