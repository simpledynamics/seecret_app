...
(function(){var h=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["friends-list-template"]=h({compiler:[7,">= 4.0.0"],main:function(e,a,d,g,f){var c;return(null!=(c=d.blockHelperMissing.call(a,e.lambda(a,a),{name:".",hash:{},fn:e.program(1,f,0),inverse:e.noop,data:f}))?c:"")+"\r\n\r\n"},1:function(e,a,d,g,f){var c,b;return'\t<div class="friendDetailsContainer" id="friendDetails_'+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?
b.call(a,{name:"id_str",hash:{},data:f}):b))+'" class="friendDetails">\r\n\t\t<img src="'+e.escapeExpression((b=null!=(b=d.profile_image_url||(null!=a?a.profile_image_url:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"profile_image_url",hash:{},data:f}):b))+'" /> <strong>'+e.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:f}):b))+"</strong> message count: "+e.escapeExpression((b=null!=
(b=d.message_count||(null!=a?a.message_count:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"message_count",hash:{},data:f}):b))+"   <a href=\"javascript:app.toggleFriendMessages('"+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'\',this.id)" id="friendMessagesToggleLink_'+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",
hash:{},data:f}):b))+'">show conversation</a> \r\n\t\t'+e.escapeExpression((d.tweetShortDate||a&&a.tweetShortDate||d.helperMissing).call(a,null!=(c=null!=a?a.most_recent:a)?c.created_at:c,{name:"tweetShortDate",hash:{},data:f}))+"  \r\n\t\t\r\n"+(null!=(c=d["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:e.program(2,f,0),inverse:e.program(4,f,0),data:f}))?c:"")+'\t\t<br/>\r\n\t\t<div id="friendMessages_'+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===
typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'" style="display:none" class="friendMessages"></div>\r\n\t</div>\r\n'},2:function(e,a,d,g,f){var c;return'\t\t\t<br/>\r\n\t\t\t<textarea id="directMessage_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'" style="width:50%"></textarea>\r\n\t\t\t<input type=button onClick="app.prepareDirectMessage(\''+e.escapeExpression((c=null!=(c=d.id_str||(null!=
a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'\')" value="Send message" class="button"/>\r\n'},4:function(e,a,d,g,f){var c;return"\t\t<br/>Not sure if "+e.escapeExpression((c=null!=(c=d.screen_name||(null!=a?a.screen_name:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"screen_name",hash:{},data:f}):c))+' has your public key?  <input type=button onClick="app.initiateDirectMessages('+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?
a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+',true)" value="send it"/>  ('+e.escapeExpression((c=null!=(c=d.screen_name||(null!=a?a.screen_name:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"screen_name",hash:{},data:f}):c))+" can't send you encryted messages until you have sent them your key)\r\n"},useData:!0})})();
...
(function(){var a=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["no-more-direct-messages-template"]=a({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,e){return'<div style="font-weight:bold">You have reached the oldest message that the Twitter platform allows you to retrieve from another app.  You must use the twitter app to get older messages.</div>'},useData:!0})})();
...
app.handleDMResponse)):console.log("getting newest but there's no since id?  ")},setupDMPostData:function(){app.dmPostData={count:100,full_text:!0,include_entities:!1,skip_status:!0}},startDirectMessages:function(){app.setupDMPostData();app.overlay();app.doDMPost(app.dmPostData,app.handleDMResponse)},doDMPost:function(a,b){app.updatingDirectMessages=!0;app.oauthResult.get("1.1/direct_messages.json",{data:a}).done(function(a){console.log("Got "+a.length+" direct messages");0<a.length?($("#olderDirectMessagesButtonContainer").show(),
app.dmSinceId||(app.dmSinceId=a[0].id_str),b(a)):(app.hideOverlays(),app.dmPostData.since_id?alert("No new direct messages"):app.dmPostData.max_id||$("#directMessages").html("You have no direct messages."))}).fail(function(a){app.hideOverlays()})},handleDMResponse:function(a){var b=null!=app.dmPostData.since_id;if(b&&0==a.length)alert("No new messages");else{$(".friendMessages").hide();console.log("handling dm response for "+a.length);if(1==a.length&&a[0].id_str==app.dmMaxId)app.hasFirstDirectMessage||
($("#directMessages").append(Handlebars.getTemplate("no-more-direct-messages-template")()),$("#olderDirectMessagesButtonContainer").hide()),app.hasFirstDirectMessage=!0,app.hideOverlays(),app.updatingDirectMessages=!1;else if(0==a.length)$("#directMessages").append(Handlebars.getTemplate("no-seecrets-in-direct-messages-template")()),app.hideOverlays(),app.updatingDirectMessages=!1;else{var c=app.processMessageList(a,"sender","dmMaxId");app.timelineContainsKeys(c)&&(console.log("saving public keys!"),
app.savePublicKeys(app.getPublicKeyMessagesFromDMList(c)));var d=app.getFriendsFromMessageList(c);app.markMessageableFriends(d);console.log("Found "+d.length+" friends");if(b){for(var e in d)null==$("#friendDetails_"+d[e].id_str)&&$("#friendsContainer").prepend([d[e]]);var b="New messages from ",g="";for(e in d)b+=g+d[e].screen_name,g=",";0<a.length&&alert(b)}else $("#friendsContainer").html(Handlebars.getTemplate("friends-list-template")(d)),app.renderFriendMessages(d,c),$("#friendsContainer").fadeIn();
app.timelineContainsEncryptedMessages(c)&&app.markEncryptedDirectMessages(c);app.updateDirectMessagesUI(c)}app.hideOverlays()}},updateDirectMessagesUI:function(a){app.hideOverlays();var b=app.getFriendsFromMessageList(a);if(app.dmPostData.since_id)for(var c in b){var d=app.filterMessageListByFriendId(a,b[c].id_str);console.log("found "+d.length+" messages from "+b[c].screen_name);0<d.length&&(console.log("rendering messages into #friendMessages_"+b[c].id_str),$("#friendMessages_"+b[c].id_str).prepend(Handlebars.getTemplate("direct-messages-template")(d)))}else app.renderFriendMessages(b,
a);app.updatingDirectMessages=!1},markMessageableFriends:function(a){var b=app.getObject("publicKeys-"+app.activeUser.user.id_str),c;for(c in a)console.log("the public key is "+b[a[c].id_str]),a[c].publicKey=b[a[c].id_str]},renderFriendMessages:function(a,b){for(var c in a)app.renderFriendMessage(a[c].id_str,b)},renderFriendMessage:function(a,b){var c=app.filterMessageListByFriendId(b,a);$("#friendMessages_"+a).append(Handlebars.getTemplate("direct-messages-template")(c))},getFriendsFromMessageList:function(a){var b=
{},c;for(c in a)b[a[c].sender.screen_name]||(b[a[c].sender.screen_name]=a[c].sender,b[a[c].sender.screen_name].most_recent=a[c]),b[a[c].sender.screen_name].message_count||(b[a[c].sender.screen_name].message_count=0),b[a[c].sender.screen_name].message_count++;a=[];for(f in b)a.push(b[f]);return a},toggleFriendMessages:function(a){"show conversation"!=$("#friendMessagesToggleLink_"+a).html()?($("#friendMessagesToggleLink_"+a).html("show conversation"),$("#friendMessages_"+a).fadeOut()):($("#friendMessagesToggleLink_"+
a).html("hide"),$("#friendMessages_"+a).fadeIn())},filterMessageListByFriendId:function(a,b){var c=[],d;for(d in a)a[d].sender.id_str!=b&&a[d].sender.id_str!=app.activeUser.id_str||c.push(a[d]);console.log("filtered "+a.length+" down to "+c.length);return c},getOlderDirectMessages:function(){app.setupDMPostData();app.dmPostData.max_id=app.dmMaxId;app.doDMPost(app.dmPostData,function(a){console.log("current max id is "+app.dmMaxId);console.log("got "+a.length+" more!");app.dmMaxId=a[a.length-1].id_str})},
isPublicKey:function(a){return app.publicKeyStartRegex.test(a)&&app.publicKeyEndRegex.test(a)},isPGPMessage:function(a){return app.pgpMessageStartRegex.test(a)&&app.pgpMessageEndRegex.test(a)},timelineContainsKeys:function(a){for(var b in a)if(app.isPublicKey(a[b].seecret))return!0;return!1},timelineContainsEncryptedMessages:function(a){for(var b in a)if(app.isPGPMessage(a[b].seecret))return!0;return!1},getPublicKeyMessagesFromDMList:function(a){var b=[],c;for(c in a)app.isPublicKey(a[c].seecret)&&
b.push(a[c]);return b},savePublicKeys:function(a){var b=app.activeUser.publicKeys;null==b&&(b={});var c={},d;for(d in a)a[d].sender.id_str!=app.activeUser.user.id&&(c[a[d].sender.id_str]||(c[a[d].sender.id_str]={key:a[d].seecret,screen_name:a[d].sender.screen_name,id_str:a[d].sender.id_str,profile_image_url:a[d].sender.profile_image_url,receiveDate:a[d].created_at}));for(var e in c)b[e]=c[e];app.saveObject("publicKeys-"+app.activeUser.user.id_str,b);app.activeUser.publicKeys=b},markEncryptedDirectMessages:function(a){for(var b in a)this.isPGPMessage(a[b].seecret)&&
(a[b].encrypted=!0,a[b].decrypted=!1)},sendPublicKeyMessages:function(a,b){app.postDirectMessages(a,function(){app.trackSentPublicKeys(b)})},trackSentPublicKeys:function(a){var b=app.activeUser.sentPublicKeys;null==b&&(b={});for(var c in a)b[c]=new Date;app.activeUser.sentPublicKeys=b;app.saveObject("sentPublicKeys-"+app.activeUser.user.id_str,b)},decryptDirectMessages:function(a){var b=openpgp.key.readArmored(app.activeUser.privateKey.armored).keys[0];if(app.decryptPrivateKey(b))app.verifyMessagesDecrypted(a,
...
app.activeUser.user.id_str,c);app.refreshActiveUserDMSenders();app.updateDirectMessagesUI(a)}},undecryptedMessageContentHandler:null,generateUndecryptedMessageContent:function(a){return Handlebars.getTemplate("undecrypted-message-content-template")(a)},showPublicKeyManager:function(a,b){app.doScroll=!1;var c={};c.receiver_name=b;c.receiver_id=a;$("#directMessagesActionsContainer").html(Handlebars.getTemplate("public-key-template")(c))},showWaitingForPublicKeyView:function(a,b){app.doScroll=!1;var c=
{};c.receiver_name=b;c.receiver_id=a;c.invite_date=moment(app.activeUser.sentPublicKeys[a]).format("MMMM Do YYYY, h:mm:ss a");$("#directMessagesActionsContainer").html(Handlebars.getTemplate("public-key-pending-template")(c))},showDirectMessageForm:function(a,b){app.doScroll=!1;var c={receiverId:a,receiverName:b};$("#directMessagesActionsContainer").html(Handlebars.getTemplate("direct-message-template")(c));app.doScroll=!1},makeKeyOptionsForUser:function(a){var b=app.generatePassword(),c=1024;openpgp.util.getWebCryptoAll()&&
(c=2048);return{numBits:c,userIds:[{name:a.name,email:a.screen_name+"@seecretApp.seecret"}],passphrase:b}},generatePassword:function(){for(var a="",b=0;50>b;b++)a+=app.getValidPasswordCharacter();return a},getValidPasswordCharacter:function(){for(;;){var a=Math.floor(206*Math.random())+48;if(!(173==a||92==a||58<=a&&64>=a||127<=a&&160>=a))return String.fromCharCode(a)}},validateNewPrivateKey:function(a){if(1>$("#"+a).val().length)return $("#"+a+"Error").html("You must have a passphrase for your key of at least one character"),
!1;$("#"+a+"Error").html("");if(confirm("Are you sure?")){var b=$("#"+a).val(),c=1==document.getElementById(a+"Cache").checked;app.hideAllViews();$("#"+app.STATUS_MESSAGE_VIEW).show();app.generatePrivateKeyPair(b,c,function(){$("#"+a).val("");confirm("Send your new key to the contacts who have the old one?")&&app.resendPublicKeys();$("#directMessagesActionsContainer").empty();app.renderPrivateKeySettings();app.setView(app.SETTINGS_VIEW)})}},resendPublicKeys:function(){var a=app.activeUser.sentPublicKeys,
b=app.activeUser.dmSenders;if(null!=a||null!=b){var c=[],d={},e;for(e in a)d[e]=!0;for(e in b)d[e]=!0;var a=0,g;for(g in d){a++;var b=app.generatePublicKeyMessages(g),h;for(h in b)c.push({receiverId:g,text:b[h]})}0<c.length&&app.sendPublicKeyMessages(c,d)}},generatePrivateKeyPair:function(a,b,c){var d=app.activeUser.user,e=app.makeKeyOptionsForUser(d);e.passphrase=a;d.id_str||(e.userId=d.id_str);null!=d&&(a=new Date,console.log("start generating key pair : "+a.getSeconds()+":"+a.getMilliseconds()),
openpgp.config.debug=!0,openpgp.generateKey(e).then(function(a){var d=new Date;console.log("done generating key pair : "+d.getSeconds()+":"+d.getMilliseconds());app.generatePrivateKeyPairSuccess(a,e,b,c)}).catch(function(a){console.log("Caught an error generatinga key pair");console.log(JSON.stringify(a))}))},generatePrivateKeyPairSuccess:function(a,b,c,d){c||delete b.passphrase;c=app.activeUser.user;var e=new Date,g={};g.armored=a.privateKeyArmored;g.dateCreated=e;var h={};h.armored=a.publicKeyArmored;
h.dateCreated=e;app.saveObject("keyOptions-"+c.id_str,b);app.saveObject("privateKey-"+c.id_str,g);app.saveObject("publicKey-"+c.id_str,h);app.checkDirectMessageStatus();app.refreshActiveUserTotal();d()},showAllDirectMessages:function(){$("#friendName").html("");$(".dmMessageDiv").fadeIn();$("#directMessagesActionsContainer").hide();$("body").scrollTop(0)},setDirectMessageReceiver:function(a,b){$("#selectedReceiverId").val(a);$("#selectedReceiverName").val(b);var c={};c.name=b;c.id_str=a;$("#friendName").html(Handlebars.getTemplate("direct-message-friend-name")(c));
app.checkDirectMessageStatus();$(".dmMessageDiv").hide();$(".dm_"+a).fadeIn();$("#directMessagesActionsContainer").show();$("body").scrollTop(0)},initiateDirectMessages:function(a,b){var c=app.generatePublicKeyMessages(a),d=[],e;for(e in c)d.push({receiverId:a,text:c[e]});b||d.push({text:app.joinMessage,receiverId:a});app.postDirectMessages(d,function(){var b={};b[a]=!0;app.trackSentPublicKeys(b);app.checkDirectMessageStatus()})},prepareDirectMessage:function(a){if(!app.sendingDirectMessage){var b=
$("#directMessage").val();0!=b.length&&(app.sendingDirectMessage=!0,app.overlay(),app.encryptDirectMessage(b,a))}},decryptPrivateKey:function(a){var b=app.activeUser.keyOptions,c=null;app.passphrase&&(c=app.passphrase);b.passphrase&&(c=b.passphrase);b.passphrase||null!=app.passphrase||(app.passphrase=c=prompt("Enter your passphrase"));if(a.decrypt(c))return!0;app.passphrase=null;return!1},encryptDirectMessage:function(a,b){var c=app.activeUser.publicKeys,d=null,e;for(e in c)e==b&&(d=c[e].key);d?(c=
openpgp.key.readArmored(d).keys,c={publicKeys:c,data:a},app.activeUser.privateKey&&(d=openpgp.key.readArmored(app.activeUser.privateKey.armored),app.decryptPrivateKey(d.keys[0])&&(c.privateKeys=d.keys)),openpgp.encrypt(c).then(function(a){a=app.hideAndCompress(a.data);app.seecret_engine.config.RANDOM_COVERTEXTS=!0;app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=1E4;a=app.seecret_engine.chainify(a,covertexts);app.seecret_engine.config.RANDOM_COVERTEXTS=!1;app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=
...
app.deleteSavedItem("keyOptions-"+app.activeUser.user.id_str),app.activeUser.privateKey=null,app.activeUser.publicKey=null,app.activeUser.keyOptions=null,app.renderPrivateKeySettings(),app.setView(app.SETTINGS_VIEW))},checkDirectMessageStatus:function(){app.doScroll=!1;var a=$("#selectedReceiverId").val(),b=$("#selectedReceiverName").val();if(a)if(null==app.activeUser.privateKey)app.showPrivateKeyManager();else{var c=app.activeUser.publicKeys,d=app.activeUser.sentPublicKeys;null==d||null==d[a]||null!=
c&&c[a]?null==c||null!=c&&!c[a]?app.showPublicKeyManager(a,b):app.showDirectMessageForm(a,b):app.showWaitingForPublicKeyView(a,b);app.doScroll=!0}},updateUserTimeline:function(a,b){b&&(app.maxId=null);app.userTimelineId=a;app.homeTimeline=!1;app.updatingTimeline=!0;var c={data:{}};c.data.count=200;c.data.screen_name=a;c.data.include_rts=!1;null!=app.maxId?c.data.max_id=app.maxId:$("#status-list").empty();app.hideOverlays();app.getUserTimeline(c,app.handleTimelineResponse)},getTimeline:function(a,
b){app.oauthResult.get("1.1/statuses/home_timeline.json",a).done(function(a){b(a);app.hideOverlays()}).fail(app.handleGetTimelineError)},getUserTimeline:function(a,b){$("#twitterUser").val("");app.oauthResult.get("1.1/statuses/user_timeline.json",a).done(function(a){b(a);app.hideOverlays()}).fail(app.handleGetTimelineError)},handleTimelineResponse:function(a){0<a.length?1==a.length&&a[0].id_str==app.maxId?$("#status-list").append(Handlebars.getTemplate("no-more-timeline-message-template")()):app.processTimelineResponse(a):
app.handleEmptyTimelineResponse(a)},handleGetTimelineError:function(a){429==a.status?alert("Twitter rate limit exceeded.  You must wait 15 minutes to make more requests from this app."):404==a.status?alert("Twitter says that screen name does not exist."):alert("There was an error retrieving the timeline.");console.log("Error:"+JSON.stringify(a));app.hideOverlays()},handleEmptyTimelineResponse:function(a){app.hideOverlays()},processTimelineResponse:function(a){app.addFollowerTagToTweets(a,app.processTimelineWithFollowerInfo)},
addFollowerTagToTweets:function(a,b){var c={},d;for(d in a)c[a[d].user.id_str]=a[d].user.id_str;d=[];for(var e in c)d.push(e);c={data:{}};c.data.user_id=d.join();app.oauthResult.get("1.1/friendships/lookup.json",c).done(function(c){var d={},e;for(e in c)0<=c[e].connections.indexOf("followed_by")&&(d[c[e].id_str]=!0);for(var l in a)d[a[l].user.id_str]&&(a[l].follower=!0);b(a)}).fail(function(c){b(a)})},unhideAndDecompressSeecretsInList:function(a,b){console.log("Unhiding the seecrets but showing all!");
var c=[],d;for(d in a)if(a[d].seecret_envelope||console.log("no seecret envelope at "+d),a[d].seecret_envelope){console.log("found a seecret enevelop in message "+d);var e=a[d].seecret_envelope,g=app.seecret_engine.getSeecretFromEnvelope(e),e=app.seecret_engine.getContentTypeFromEnvelope(e),g=app.seecret_engine.unhide(g,e);if(e==app.seecret_engine.config.CONTENT_TYPES.NUMBERS_ARRAY)try{g=seecret_compression.decompress(g),a[d].seecret=g}catch(h){console.log("error decompressing a seecret message: "+
JSON.stringify(h)),a[d].seecret="Could not decompress the Seecret",a[d].seecret_error=h}else a[d].seecret=g;c.push(a[d])}else b&&!app.seecret_engine.hasSeecretContent(a[d].text)&&c.push(a[d]);return c},unhideAndDecompressTimelineSeecrets:function(a,b){var c=[],d;for(d in a)if(a[d].seecret_envelope){var e=a[d].seecret_envelope,g=app.seecret_engine.getSeecretFromEnvelope(e),e=app.seecret_engine.getContentTypeFromEnvelope(e),g=app.seecret_engine.unhide(g,e);if(e==app.seecret_engine.config.CONTENT_TYPES.NUMBERS_ARRAY)try{g=
seecret_compression.decompress(g),a[d].seecret=g}catch(h){console.log("error decompressing a seecret message: "+JSON.stringify(h)),a[d].seecret="Could not decompress the Seecret",a[d].seecret_error=h}else a[d].seecret=g;c.push(a[d])}else b&&!app.seecret_engine.hasSeecretContent(a[d].text)&&c.push(a[d]);return c},getEarliestIncompleteChainStartId:function(a,b){for(var c in b)app.getFirstIncompleteChainStart(a,b[c])},getEarliestIncompleteDMChainStartId:function(a,b){for(var c in b)app.getFirstIncompleteDMChainStart(a,
...
$("#directMessagesActionsContainer").val("");$("#textarea-statusUpdate").val("");$("#importPrivateKeyText").val("");$("#importPrivateKeyPassphrase").val("");$("#privateKeyTextarea").val("");$("#privateKeyPassphrase").val("");$("#privateKeyCopyarea").empty();$("#publicKeysDisplayArea").empty();app.unauthenticatedHeader();$("#privateMessageButton").hide();$("#timelineButton").hide();app.unauthenticatedMenu();app.setView(app.ABOUT_VIEW)},authenticatedMenu:function(){$("#privateMessageButton").show();
$("#timelineButton").show();$("#settingsButton").show();$("#logoutButton").show();$("#hashesButton").show();$("#publicKeysButton").show();$("#aboutButton").show()},unauthenticatedMenu:function(){$("#privateMessageButton").hide();$("#timelineButton").hide();$("#settingsButton").hide();$("#logoutButton").hide();$("#publicKeysButton").hide()},authenticatedHeader:function(){app.activeUser&&app.activeUser.user&&(app.activeUser.user.profile_image_url=app.activeUser.user.profile_image_url.replace(app.httpsReplaceRegex,
"https:"),$("#loginContainer").html(Handlebars.getTemplate("authenticated-header-template")(app.activeUser.user)))},unauthenticatedHeader:function(){$("#loginContainer").html(Handlebars.getTemplate("unauthenticated-header-template")())},hideAllViews:function(){$("#timeline").hide();$("#statusMessage").hide();$("#privateMessages").hide();$("#settings").hide();$("#publicKeys").hide();$("#about").hide();$("#hashes").hide()},setMenuState:function(a){$.each($(".menuLink"),function(a,c){$(this).css("background",
