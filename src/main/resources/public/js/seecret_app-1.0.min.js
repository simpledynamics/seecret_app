...
null!=(b=null!=a?a.most_recent:a)?b.created_at:b,{name:"tweetShortDate",hash:{},data:e}))+"\r\n"+(null!=(b=c["if"].call(a,null!=a?a.newMessages:a,{name:"if",hash:{},fn:f.program(2,e,0),inverse:f.noop,data:e}))?b:"")+(null!=(b=c["if"].call(a,null!=a?a.unencryptedMessages:a,{name:"if",hash:{},fn:f.program(4,e,0),inverse:f.noop,data:e}))?b:"")+"\t\t\t\t\t\t \r\n\t\t\t<br/><a href=\"javascript:app.toggleFriendMessages('"+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?d:c.helperMissing,
...
typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+'\')" value="Send message" class="button" /> ( Not sure if '+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+' has your public key?  <input type=button class="button" onClick="app.initiateDirectMessages('+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",
hash:{},data:e}):b))+',true)" value="Send it"/>)\r\n\t\t</div>\r\n'},useData:!0})})();
...
2:function(c,a,e,f,d){return'\t\t\t\t\t\t\t\t<img src="https://cdn.rawgit.com/simpledynamics/seecret_app/d43b1cab4428ce1e945c2cfcdcab4243b1258284/src/main/resources/public/img/encrypted.png" class="dmIcon" alt="Encrypted" title="Encrypted" />\r\n'},4:function(c,a,e,f,d){return'\t\t\t\t\t\t\t\t<img src="https://cdn.rawgit.com/simpledynamics/seecret_app/d43b1cab4428ce1e945c2cfcdcab4243b1258284/src/main/resources/public/img/signed.jpg" class="dmIcon" alt="Signed" title="Signed" />\r\n'},6:function(c,
a,e,f,d){return'\t\t\t\t\t\t\t\t<img src="https://cdn.rawgit.com/simpledynamics/seecret_app/e449e723f317fce6866a09c016d36acddaaac9d6/src/main/resources/public/img/new-icon.png" class="dmIconNew" alt="New" title="New" />\r\n'},8:function(c,a,e,f,d){var b;return"\r\n\t\t\t\t\t\t\t\t"+c.escapeExpression((b=null!=(b=e.seecret||(null!=a?a.seecret:a))?b:e.helperMissing,"function"===typeof b?b.call(a,{name:"seecret",hash:{},data:d}):b))+"\r\n"},10:function(c,a,e,f,d){var b,g;return"\t\t\t\t\t\t\t\t"+(null!=
(b=(g=null!=(g=e.text||(null!=a?a.text:a))?g:e.helperMissing,"function"===typeof g?g.call(a,{name:"text",hash:{},data:d}):g))?b:"")+"\r\n\t\t\t\t\t\t\t\t"},useData:!0})})();
...
console.log("no new friends")}},updateDirectMessagesUI:function(a,b){app.hideOverlays();b=b?b:app.getFriendsFromMessageList(a);app.renderAllFriendMessages(b,a);app.updatingDirectMessages=!1},markMessageableFriends:function(a){var b=app.getObject("publicKeys-"+app.activeUser.user.id_str),c;for(c in a)console.log("the public key is "+b[a[c].id_str]),a[c].publicKey=b[a[c].id_str]},markFriendsWithSentKeys:function(a){console.log("marking friends with sent keys!");var b=app.getObject("sentPublicKeys-"+
app.activeUser.user.id_str),c;for(c in b)for(var d in a)c==a[d].id_str&&(a[d].sentKey=b[c])},markFriendsWithUnencryptedMessages:function(a,b){for(var c in a){a[c].unencryptedMessages=!1;for(var d in b)if(b[d].encrypted&&!b[d].encryptionSuccessful){a[c].unencryptedMessages=!0;break}}},renderAllFriendMessages:function(a,b){for(var c in a)app.renderFriendMessages(a[c].id_str,b)},renderFriendMessages:function(a,b){var c=app.filterMessageListByFriendId(b,a);if(app.dmPostData.since_id){console.log("prepending "+
c.length+" new messages from "+a);for(var d in c)c[d].new=!0;$("#friendMessages_"+a).prepend(Handlebars.getTemplate("direct-messages-template")(c))}else $("#friendMessages_"+a).append(Handlebars.getTemplate("direct-messages-template")(c))},getFriendsFromMessageList:function(a){var b={},c;for(c in a)b[a[c].sender.screen_name]||(b[a[c].sender.screen_name]=a[c].sender,b[a[c].sender.screen_name].most_recent=a[c],console.log("Most recent message from "+a[c].sender.screen_name+" is "+a[c].created_at)),
b[a[c].sender.screen_name].message_count||(b[a[c].sender.screen_name].message_count=0),b[a[c].sender.screen_name].message_count++;a=[];for(f in b)a.push(b[f]);return a},toggleFriendMessages:function(a){"show conversation"!=$("#friendMessagesToggleLink_"+a).html()?(console.log("updating conversation link to say 'show conversation'"),$("#friendMessagesToggleLink_"+a).html("show conversation"),console.log("hiding friendMessagesForm_"+a),$("#friendMessageForm_"+a).fadeOut(),console.log("hiding friendMessages_"+
a),$("#friendMessages_"+a).fadeOut()):($("#friendMessagesToggleLink_"+a).html("hide conversation"),$("#friendMessageForm_"+a).fadeIn(),$("#friendMessages_"+a).fadeIn())},filterMessageListByFriendId:function(a,b){var c=[],d;for(d in a)a[d].sender.id_str!=b&&a[d].sender.id_str!=app.activeUser.id_str||c.push(a[d]);console.log("filtered "+a.length+" down to "+c.length);return c},getOlderDirectMessages:function(){app.hasFirstDirectMessage||(app.setupDMPostData(),app.dmPostData.max_id=app.dmMaxId,app.doDMPost(app.dmPostData,
...
for(h in e){console.log("finding first incomplete message start for "+h);var e=0,k;for(k in a)d(a[k])==h&&app.seecret_engine.hasSeecretContent(a[k].text)&&(app.seecret_engine.isEnvelopeStart(a[k].text)&&(e=k),app.seecret_engine.isEnvelopeEnd(a[k].text)&&(e=0));0<e&&0==g?g=e:0<e&&e<g&&(g=e)}d=g;0<d&&(app[c]=a[d].id_str);console.log("unhideAndDecompress started with "+a.length);a=app.unhideAndDecompressSeecretsInList(a,!0);console.log("unhideAndDecompress left "+a.length);for(k in a)a[k][b]&&a[k][b].profile_image_url&&
(a[k][b].profile_image_url=a[k][b].profile_image_url.replace(app.httpsReplaceRegex,"https:"));return a},processTimelineWithFollowerInfo:function(a){var b=null;app.dmPost&&app.dmPost.since_id&&app.dmMaxId&&(b=app.dmMaxId);a=app.processMessageList(a,"user","maxId");b&&(app.dmMaxId=b);0<a.length?$("#status-list").append(Handlebars.getTemplate("status-template")(a)):document.getElementById("showOnlySeecrets").checked&&$("#status-list").append(Handlebars.getTemplate("no-seecrets-in-timeline-segment-template")());
$(".basicTweet").fadeIn();app.updatingTimeline=!1;app.userTimelineId?app.renderUserTimelineHeader(app.userTimelineId):$("#timelineName").html("")},renderUserTimelineHeader:function(a){$("#timelineName").html("for "+a+" &nbsp;&nbsp;&nbsp;<a href='javascript:app.initTimeline();app.updateHomeTimeline()'>Back to my timeline</a>")},dechainifyMessages:function(a,b,c){for(var d in b)if(0<b[d].length){var e=function(a){return a&&a.text&&"string"==typeof a.text&&a[c]&&a[c].id_str==d?a:null},g=0,h;for(h in b[d]){var k=
...
$("#importPrivateKeyText").val("");$("#importPrivateKeyPassphrase").val("");$("#privateKeyTextarea").val("");$("#privateKeyPassphrase").val("");$("#privateKeyCopyarea").empty();$("#publicKeysDisplayArea").empty();app.unauthenticatedHeader();$("#privateMessagesButton").hide();$("#timelineButton").hide();app.unauthenticatedMenu();app.setView(app.ABOUT_VIEW)},authenticatedMenu:function(){$("#privateMessagesButton").show();$("#timelineButton").show();$("#settingsButton").show();$("#logoutButton").show();
...
(function(){var a=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["undecrypted-message-content-template"]=a({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,e){return"Could not decrypt."},useData:!0})})();
