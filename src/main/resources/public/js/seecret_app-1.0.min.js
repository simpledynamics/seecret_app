...
!0;$("#directMessagesActionsContainer").empty();$("#directMessagesBreadCrumbContainer").empty();$("#friendName").empty();app.overlay();app.oauthResult.get("1.1/direct_messages.json",{data:app.dmPostData}).done(function(a){0<a.length?($("#olderDirectMessagesButtonContainer").show(),app.dmSinceId||(app.dmSinceId=a[0].id_str),app.processDirectMessagesResponse(a)):(app.hideOverlays(),app.dmPostData.since_id?alert("No new direct messages"):app.dmPostData.max_id||$("#directMessages").html("You have no direct messages."))}).fail(function(a){app.hideOverlays()})},
updateDirectMessagesUI:function(a){app.hideOverlays();app.dmPostData.since_id?$("#directMessages").prepend(Handlebars.getTemplate("direct-messages-template")(a)):$("#directMessages").append(Handlebars.getTemplate("direct-messages-template")(a));app.updatingDirectMessages=!1},publicKeyStartRegex:/^\s*-----BEGIN PGP PUBLIC KEY BLOCK-----\s/,publicKeyEndRegex:/\s-----END PGP PUBLIC KEY BLOCK-----\s*$/,pgpMessageStartRegex:/^\s*-----BEGIN PGP MESSAGE-----/,pgpMessageEndRegex:/\s-----END PGP MESSAGE-----\s*$/,
