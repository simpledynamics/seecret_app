...
c.call(a,{name:"id_str",hash:{},data:f}):c))+'">\r\n\t\t<div style="display:inline-block;vertical-align:top;margin:0 0.5em 0 0;">\r\n\t\t\t<img src="'+e.escapeExpression((c=null!=(c=d.profile_image_url||(null!=a?a.profile_image_url:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"profile_image_url",hash:{},data:f}):c))+'" class="profileImg" />\r\n\t\t</div>\r\n\t\t<div style="display:inline-block;vertical-align:top;max-width:80%">\r\n\t\t\t<div>\r\n\t\t\t\tYou have <span id="messageCount_'+
e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'">'+e.escapeExpression((c=null!=(c=d.message_count||(null!=a?a.message_count:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"message_count",hash:{},data:f}):c))+' messages</span> from <span style="font-weight:bold;">'+e.escapeExpression((c=null!=(c=d.screen_name||(null!=a?a.screen_name:a))?c:d.helperMissing,"function"===typeof c?c.call(a,
{name:"screen_name",hash:{},data:f}):c))+"</span>; last message: "+e.escapeExpression((d.tweetShortDate||a&&a.tweetShortDate||d.helperMissing).call(a,null!=(b=null!=a?a.most_recent:a)?b.created_at:b,{name:"tweetShortDate",hash:{},data:f}))+" <a href=\"javascript:app.toggleFriendMessages('"+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'\',this.id)" id="friendMessagesToggleLink_'+e.escapeExpression((c=
null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'">show conversation</a> \r\n\t\t\t</div>\r\n\t\t\t<div id="friendKeyContainer_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'">\r\n'+(null!=(b=d.unless.call(a,null!=a?a.sentKey:a,{name:"unless",hash:{},fn:e.program(2,f,0),inverse:e.noop,data:f}))?b:"")+'\t\t\t</div>\r\n\t\t</div>\r\n\t\t<div id="friendPublicKeyDetails_'+
e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'" style="padding:0.5em 0">\r\n'+(null!=(b=d["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:e.program(4,f,0),inverse:e.noop,data:f}))?b:"")+'\t\t</div>\t\t\r\n\t\t<div id="friendMessages_'+e.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:f}):c))+'" style="display:none" class="friendMessages"></div>\r\n\t</div>\r\n'},
2:function(e,a,d,g,f){var b;return'\t\t\t\t<input type=button value="Invite '+e.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:f}):b))+'" onClick="app.initiateDirectMessages('+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+')"/>.  \r\n\t\t\t\t<br/>You can send '+e.escapeExpression((b=null!=(b=
d.receiver_name||(null!=a?a.receiver_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"receiver_name",hash:{},data:f}):b))+" messages once they accept your invite.\r\n"},4:function(e,a,d,g,f){var b;return'\t\t\t<div id="friendMessageForm_'+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'" style="display:none">\r\n\t\t\t\t<textarea id="directMessage_'+e.escapeExpression((b=null!=(b=d.id_str||
(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'" class="dmField"></textarea>\r\n\t\t\t\t<input type=button onClick="app.prepareDirectMessage(\''+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+'\')" value="Send message" class="button" />\r\n\t\t\t\t<div style="margin:5px 0;">Not sure if '+e.escapeExpression((b=null!=(b=d.screen_name||(null!=
a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:f}):b))+' has your public key?  <input type=button class="button" onClick="app.initiateDirectMessages('+e.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:f}):b))+',true)" value="Send it"/></div>\r\n\t\t\t</div>\r\n'},useData:!0})})();
...
b);app.activeUser.publicKeys=b},markEncryptedDirectMessages:function(a){for(var b in a)this.isPGPMessage(a[b].seecret)&&(a[b].encrypted=!0,a[b].decrypted=!1)},sendPublicKeyMessages:function(a,b){app.postDirectMessages(a,function(){app.trackSentPublicKeys(b)})},trackSentPublicKeys:function(a){var b=app.activeUser.sentPublicKeys;null==b&&(b={});for(var c in a)b[c]=new Date;app.activeUser.sentPublicKeys=b;app.saveObject("sentPublicKeys-"+app.activeUser.user.id_str,b)},decryptDirectMessages:function(a){app.timer("decryptDirectMessages");
var b=openpgp.key.readArmored(app.activeUser.privateKey.armored).keys[0];if(app.decryptPrivateKey(b))app.verifyMessagesDecrypted(a,b);else{alert("Could not verify your passphrase.  Showing messages undecrypted.");for(var c in a)a[c].encrypted&&(a[c].text+=" (could not decrypt)");app.updateDirectMessagesUI(a)}},verifyMessagesDecrypted:function(a,b){var c=null,d;for(d in a)if(a[d].encrypted&&0==a[d].decrypted){c=d;break}var e=app.activeUser.user;if(null!=c)if(a[c].sender.id_str==e.id)a[c].decrypted=
!0,app.verifyMessagesDecrypted(a,b);else{a[c].decrypted=!0;a[c].decryptionSuccessful=!1;a[c].originaltext=a[c].text;try{var g=openpgp.message.readArmored(a[c].seecret),h={privateKey:b,message:g};if(app.activeUser.publicKeys&&app.activeUser.publicKeys[a[c].sender.id_str]){var k=openpgp.key.readArmored(app.activeUser.publicKeys[a[c].sender.id_str].key);h.publicKeys=k.keys}try{openpgp.decrypt(h).then(function(b){a[d].decryptionSuccessful=!0;a[d].seecret=b.data;b.signatures&&0<b.signatures.length&&b.signatures[0].valid&&
(a[d].signed=!0);app.verifyMessagesDecrypted(a,h.privateKey)},function(b){a[d].text=app.generateUndecryptedMessageContent(a[d]);app.verifyMessagesDecrypted(a,h.privateKey)})}catch(m){console.log("try/catch error decrypting: "+JSON.stringify(m)),a[d].text=app.generateUndecryptedMessageContent(a[d]),app.verifyMessagesDecrypted(a,b)}}catch(m){console.log("major try/catch error decrypting: "+JSON.stringify(m)),a[d].text=app.generateUndecryptedMessageContent(a[d]),app.verifyMessagesDecrypted(a,b)}}else{(c=
app.activeUser.dmSenders)||(c={});for(var l in a)a[l].encrypted&&a[l].sender.id_str!=app.activeUser.id&&(c[a[l].sender.id_str]=!0);app.saveObject("dmSenders-"+app.activeUser.user.id_str,c);app.refreshActiveUserDMSenders();app.timer("decryptDirectMessages");app.timer("updateDirectMessagesUI");app.updateDirectMessagesUI(a);app.timer("updateDirectMessagesUI")}},undecryptedMessageContentHandler:null,generateUndecryptedMessageContent:function(a){return Handlebars.getTemplate("undecrypted-message-content-template")(a)},
...
getUserTimeline:function(a,b){$("#twitterUser").val("");app.oauthResult.get("1.1/statuses/user_timeline.json",a).done(function(a){b(a);app.hideOverlays()}).fail(app.handleGetTimelineError)},handleTimelineResponse:function(a){app.timer("Get timeline");0<a.length?1==a.length&&a[0].id_str==app.maxId?($("#status-list").append(Handlebars.getTemplate("no-more-timeline-message-template")()),$("#getOlderTimelineButton").hide()):(app.timer("Process timeline Response"),app.processTimelineResponse(a),app.timer("Process timeline Response")):
...
$(document).ready(function(){$("body").html(Handlebars.getTemplate("body-template")());openpgp.config.show_comment=!1;openpgp.config.show_version=!1;app.seecret_engine=new SEECRET_ENGINE;$(window).scroll(function(){if(app.doScroll){var a=$(window).scrollTop(),b=$(window).height(),c=$(document).height();a+b==c&&("block"!=document.getElementById("timeline").style.display||app.updatingTimeline?document.getElementById("privateMessages"):app.homeTimeline?app.updateHomeTimeline():app.updateUserTimeline(app.userTimelineId))}});
$("#textarea-statusUpdate").keyup(function(a){app.processScaffolding()});$("#textarea-statusUpdate").change(function(a){app.processScaffolding()});$("#scaffoldingEntryContainer0").keyup(function(a){app.processScaffoldField(0);app.processScaffolding()});$("#updateStatusForm").submit(function(a){a.preventDefault();app.updateStatus()});$("#hashesContent").html(Handlebars.getTemplate("hashes-template")(hashes));app.initialize()});
...
(function(){var a=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["undecrypted-message-content-template"]=a({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,e){return'This message could not be decrypted.  Read the <a href="https://www.seecret.net/faq.html#couldnotbedecrypted">FAQ</a> to understand why.'},useData:!0})})();
