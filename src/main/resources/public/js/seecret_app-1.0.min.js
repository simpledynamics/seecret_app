...
(app.dmSinceId=a[0].id_str),b(a)):(app.hideOverlays(),app.dmPostData.since_id?alert("No new direct messages"):app.dmPostData.max_id||$("#directMessages").html("You have no direct messages."))}).fail(function(a){app.hideOverlays()})},handleDMResponse:function(a){app.timer("handleDMResponse");var b=null!=app.dmPostData.since_id;if(b&&0==a.length)alert("No new messages");else{$(".friendMessages").hide();console.log("handling dm response for "+a.length);if(1==a.length&&a[0].id_str==app.dmMaxId)app.hasFirstDirectMessage||
