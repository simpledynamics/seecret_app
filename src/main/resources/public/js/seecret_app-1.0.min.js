...
useData:!0})})();
(function(){var h=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["conversation-status-template"]=h({compiler:[7,">= 4.0.0"],main:function(f,a,d,g,e){var b,c;return'\t<div id="conversationStatusContainer_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'">\r\n\t<div style="display:inline-block;vertical-align:top;margin:0 0.5em 0 0;">\r\n\t\t<img src="'+f.escapeExpression((c=null!=
(c=d.profile_image_url||(null!=a?a.profile_image_url:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"profile_image_url",hash:{},data:e}):c))+'" class="profileImg" />\r\n\t</div>\r\n\t<div class="dm_profileCopy">\r\n\t\t<div id="conversationInfoDiv_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'">\r\n'+(null!=(b=d["if"].call(a,null!=a?a.message_count:a,{name:"if",hash:{},fn:f.program(1,
e,0),inverse:f.program(4,e,0),data:e}))?b:"")+'\t\t</div>\r\n\t\t<div id="friendKeyContainer_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'">\r\n'+(null!=(b=d["if"].call(a,null!=a?a.sentKey:a,{name:"if",hash:{},fn:f.program(6,e,0),inverse:f.program(9,e,0),data:e}))?b:"")+'\t\t</div>\r\n\t</div>\r\n\t<div id="friendPublicKeyDetails_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?
c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'" style="padding:0.5em 0">\r\n'+(null!=(b=d["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:f.program(14,e,0),inverse:f.noop,data:e}))?b:"")+"\t</div>\r\n\t</div>\t\t\r\n"},1:function(f,a,d,g,e){var b,c;return'\t\t\t<span style="font-weight:bold;">'+f.escapeExpression((c=null!=(c=d.screen_name||(null!=a?a.screen_name:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"screen_name",hash:{},data:e}):
c))+"</span> most recent "+f.escapeExpression((d.tweetShortDate||a&&a.tweetShortDate||d.helperMissing).call(a,null!=(b=null!=a?a.most_recent:a)?b.created_at:b,{name:"tweetShortDate",hash:{},data:e}))+"\r\n"+(null!=(b=d["if"].call(a,null!=a?a.newMessages:a,{name:"if",hash:{},fn:f.program(2,e,0),inverse:f.noop,data:e}))?b:"")+"\t\t\t<br/>\r\n\t\t\t<a href=\"javascript:app.toggleFriendMessages('"+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,
{name:"id_str",hash:{},data:e}):c))+'\',this.id)" id="friendMessagesToggleLink_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'">show conversation</a> (<span id="messageCount_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'">'+f.escapeExpression((c=null!=(c=d.message_count||(null!=a?a.message_count:
a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"message_count",hash:{},data:e}):c))+"</span>)\r\n"},2:function(f,a,d,g,e){var b;return'\t\t\t\t\t<i class="fa fa-comments msgCount'+f.escapeExpression((b=null!=(b=d.newMessageCount||(null!=a?a.newMessageCount:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"newMessageCount",hash:{},data:e}):b))+'" aria-hidden="true" style="font-size:1.5em" id="newMessagesStatus_'+f.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:
d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+'"></i>\r\n'},4:function(f,a,d,g,e){var b;return"\t\t\tNo Seecret messages from "+f.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+" \r\n"},6:function(f,a,d,g,e){var b;return null!=(b=d.unless.call(a,null!=a?a.publicKey:a,{name:"unless",hash:{},fn:f.program(7,e,0),inverse:f.noop,data:e}))?b:""},7:function(f,
a,d,g,e){var b;return'\t\t\t\t\x3c!-- user has sent their key to this follower but has not received a public key in return.  TODO:  make this a key request --\x3e\r\n\t\t\t\t<input type=button value="Invite '+f.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+'" onClick="app.keyRequest('+f.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?
b.call(a,{name:"id_str",hash:{},data:e}):b))+')"/>\r\n\t\t\t\t(You may be seeing this because you are using a new mirror site or a different device.  Read more in the <a href="https://www.seecret.net/faq.html" target="_new">FAQ</a>) \r\n'},9:function(f,a,d,g,e){var b;return null!=(b=d["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:f.program(10,e,0),inverse:f.program(12,e,0),data:e}))?b:""},10:function(f,a,d,g,e){var b;return"\t\t\t\t\x3c!-- user has received this follower's public key but has not sent their own public key in response --\x3e\r\n\t\t\t\t<br/>"+
f.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+' wants to message you with Seecret.  <input type=button value="Allow" onClick="app.invite('+f.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+',true)"/>\r\n'},12:function(f,a,d,g,e){var b;return'\t\t\t\t\x3c!-- user has not sent or received public keys with this follower --\x3e\r\n\t\t\t\t<input type=button value="Invite '+
f.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+'" onClick="app.invite('+f.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+')"/>.  \r\n\t\t\t\t<br/>You can send '+f.escapeExpression((b=null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",
hash:{},data:e}):b))+" messages once they accept your invite\r\n"},14:function(f,a,d,g,e){var b,c;return'\t\t<div id="friendMessageForm_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'" style="display:none">\r\n\t\t\t<textarea id="directMessage_'+f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'" class="dmField"></textarea>\r\n\t\t\t<input type=button onClick="app.prepareDirectMessage(\''+
f.escapeExpression((c=null!=(c=d.id_str||(null!=a?a.id_str:a))?c:d.helperMissing,"function"===typeof c?c.call(a,{name:"id_str",hash:{},data:e}):c))+'\')" value="Send message" class="button" />\r\n'+(null!=(b=d["if"].call(a,null!=a?a.sentKey:a,{name:"if",hash:{},fn:f.program(15,e,0),inverse:f.noop,data:e}))?b:"")+"\t\t</div>\r\n"},15:function(f,a,d,g,e){var b;return'\t\t\t<div style="margin:10px 0 0 0;padding:5px; border:1px solid #fff;background:#e4dcdc;color:#333">Not sure if '+f.escapeExpression((b=
null!=(b=d.screen_name||(null!=a?a.screen_name:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+' has been allowed to message you?  <input type=button class="button" onClick="app.invite('+f.escapeExpression((b=null!=(b=d.id_str||(null!=a?a.id_str:a))?b:d.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+',true)" value="Allow"/></div>\r\n'},useData:!0})})();
...
inverse:c.noop,data:d}))?b:"")+(null!=(b=e["if"].call(a,null!=a?a.signed:a,{name:"if",hash:{},fn:c.program(4,d,0),inverse:c.noop,data:d}))?b:"")+'\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t\t<div class="directMessage">'+(null!=(b=e["if"].call(a,null!=a?a.decryptionSuccessful:a,{name:"if",hash:{},fn:c.program(6,d,0),inverse:c.program(8,d,0),data:d}))?b:"")+"</div>\r\n\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n"},2:function(c,a,e,g,d){return'\t\t\t\t\t\t\t\t\t\x3c!-- <img src="https://cdn.rawgit.com/simpledynamics/seecret_app/d43b1cab4428ce1e945c2cfcdcab4243b1258284/src/main/resources/public/img/encrypted.png" class="dmIcon" alt="Encrypted" title="Encrypted" /> --\x3e\r\n\t\t\t\t\t\t\t\t\t<i class="fa fa-lock" aria-hidden="true" style="font-size:1em;" title="Encrypted"></i>\r\n'},
4:function(c,a,e,g,d){return'\t\t\t\t\t\t\t\t\t\x3c!-- <img src="https://cdn.rawgit.com/simpledynamics/seecret_app/d43b1cab4428ce1e945c2cfcdcab4243b1258284/src/main/resources/public/img/signed.jpg" class="dmIcon" alt="Signed" title="Signed" /> --\x3e\r\n\t\t\t\t\t\t\t\t\t<i class="fa fa-check-square" aria-hidden="true" style="font-size:1em;" title="Signed"></i>\r\n'},6:function(c,a,e,g,d){var b;return"\r\n\t\t\t\t\t\t\t\t"+c.escapeExpression((b=null!=(b=e.seecret||(null!=a?a.seecret:a))?b:e.helperMissing,
...
app.getObject("dmSenders-"+app.activeUser.user.id_str);app.activeUser.dmSenders=a},initialize:function(){app.initOauth()},loginToTwitter:function(){OAuth.popup("twitter",{options:{cache:!0}}).done(function(a){console.log("oauth done!");app.oauthResult=a;app.saveOauth();app.updateOauthUserInfo()}).fail(function(a){console.log(JSON.stringify(a));alert("Error logging into Twitter.  Please try again");app.unauthenticatedUI()})},logoutFromTwitter:function(){app.oauthResult=null;app.lastProcessedStatusId=
null;app.lastProcessedMessageId=null;app.dmMaxId=null;app.postedDirectMessageId=null;app.directMessagesToPost=null;app.directMessageCount=null;app.maxId=null;app.activeUser={};app.lastId=null;app.password=null;app.postCompleteCount=0;app.postCompleteTarget=0;app.deleteSavedItem("user");localStorage.removeItem("oauth_token");localStorage.removeItem("oauth_token_secret");app.hideAllViews();app.unauthenticatedUI()},initOauth:function(){OAuth.initialize(oauthio_key.key);null==app.oauthResult&&app.loadOauth();
app.updateOauthUserInfo()},saveOauth:function(){localStorage.setItem("oauth_token",app.oauthResult.oauth_token);localStorage.setItem("oauth_token_secret",app.oauthResult.oauth_token_secret)},loadOauth:function(){var a=localStorage.getItem("oauth_token"),b=localStorage.getItem("oauth_token_secret");if(null==a||null==b)return null;app.oauthResult=OAuth.create("twitter",{oauth_token:a,oauth_token_secret:b})},updateOathUserInfoComplete:function(a){null!=app.activeUser&&null!=app.activeUser.user&&null!=
app.activeUser.user.id_str&&null==app.activeUser.privateKey?(app.hideAllViews(),$("#"+app.STATUS_MESSAGE_VIEW).show(),app.generatePrivateKeyPair(app.generatePassword(),!0,function(){app.updateUIBasedUponOauthResult()})):app.updateUIBasedUponOauthResult()},updateOauthUserInfo:function(){null!=app.oauthResult?app.oauthResult.me().done(function(a){app.activeUser.user=a.raw;app.refreshActiveUserTotal();app.updateOathUserInfoComplete(a)}).fail(function(a){alert("There was an error logging you into Twitter.  Please reload the page and try again.")}):
app.updateOathUserInfoComplete()},updateUIBasedUponOauthResult:function(){null!=app.oauthResult?(app.authenticatedUI(),app.maxId=null,app.setViewFromHash(document.location.hash)):app.unauthenticatedUI()},setViewFromHash:function(a){switch(a){case "#timeline":app.updateHomeTimeline();app.setView(app.TIMELINE_VIEW);break;case "#privateMessages":app.initializeDirectMessagesView();break;case "#settings":app.setView(app.SETTINGS_VIEW);break;case "#about":app.setView(app.ABOUT_VIEW);break;case "#hashes":app.setView(app.HASHES_VIEW);
break;default:app.updateHomeTimeline(),app.setView(app.TIMELINE_VIEW)}},initializeDirectMessagesView:function(){app.setView(app.DIRECT_MESSAGES_VIEW);""==$("#friendsContainer").html()&&app.startDirectMessages()},getNewestDirectMessages:function(){app.setupDMPostData();app.dmSinceId&&(app.dmPostData.since_id=app.dmSinceId);app.overlay();app.doDMPost(app.dmPostData,app.handleDMResponse)},setupDMPostData:function(){app.dmPostData={count:app.NUM_DM,full_text:!0,include_entities:!1,skip_status:!0}},startDirectMessages:function(){app.setupDMPostData();
app.overlay();app.doDMPost(app.dmPostData,app.handleDMResponse)},doDMPost:function(a,b){app.updatingDirectMessages=!0;app.timer("direct message post");app.oauthResult.get("1.1/direct_messages.json",{data:a}).done(function(a){app.timer("direct message post");0<a.length?(a.length==app.NUM_DM&&$("#getOlderMessagesButton").show(),app.dmPostData.max_id||(app.dmSinceId=a[0].id_str),b(a)):(app.hideOverlays(),app.dmPostData.since_id?alert("No new direct messages"):app.dmPostData.max_id||$("#directMessages").html("You have no direct messages."))}).fail(function(a){app.hideOverlays()})},
toConversation:function(a){app.setView(app.DIRECT_MESSAGES_VIEW);null==document.getElementById("friendDetails_"+a)?app.getFollowerInfo(a,app.createConversationEntry):app.toggleFriendMessages(a,"friendMessagesToggleLink_"+a)},getFollowerInfo:function(a,b){app.oauthResult.get("1.1/users/show.json?user_id="+a).done(function(a){b(a);$("#friendMessageForm_"+a.id_str).show()}).fail(function(a){console.log("Error getting new follower id "+JSON.stringify(a))})},createConversationEntry:function(a){var b=app.getObject("publicKeys-"+
app.activeUser.user.id_str);b&&(a.publicKey=b[a.id_str]);if(b=app.getObject("sentPublicKeys-"+app.activeUser.user.id_str))a.sentKey=b[a.id_str];$("#friendsContainer").append(Handlebars.getTemplate("conversation-template")(a))},handleDMResponse:function(a){app.timer("handleDMResponse");1==a.length&&a[0].id_str==app.dmMaxId?(app.hasFirstDirectMessage=!0,app.updatingDirectMessages=!1):0==a.length?($("#directMessages").append(Handlebars.getTemplate("no-seecrets-in-direct-messages-template")()),app.hideOverlays(),
app.updatingDirectMessages=!1):(a=app.processMessageList(a,"sender","dmMaxId"),app.timelineContainsKeys(a)&&app.savePublicKeys(app.getPublicKeyMessagesFromDMList(a)),app.timelineContainsEncryptedMessages(a)?(app.markEncryptedDirectMessages(a),app.decryptDirectMessages(a)):(app.createConversationEntries(a),app.updateDirectMessagesUI(a,friendList)));app.hideOverlays();app.timer("handleDMResponse")},createConversationEntries:function(a){var b=app.getFriendsFromMessageList(a);if(null!=app.dmPostData.since_id){var c=
"New messages from ",d="",e;for(e in b)c+=d+b[e].screen_name,d=",";0<a.length&&alert(c);for(e in b)b[e].newMessages=!0,b[e].newMessageCount=8<b[e].message_count?9:b[e].message_count}app.markMessageableFriends(b);app.markFriendsWithSentKeys(b);app.markFriendsWithUnencryptedMessages(b,a);if($("#friendsContainer").is(":empty"))$("#friendsContainer").html(Handlebars.getTemplate("conversations-template")(b));else{a=[];for(e in b)if(null==document.getElementById("friendDetails_"+b[e].id_str))a.push(b[e]);
else{if(c=$("#messageCount_"+b[e].id_str).html())b[e].message_count+=parseInt(c);c=!1;"hide conversation"==$("#friendMessagesToggleLink_"+b[e].id_str).html()&&(c=!0);$("#conversationStatusContainer_"+b[e].id_str).replaceWith(Handlebars.getTemplate("conversation-status-template")(b[e]));c&&($("#friendMessageForm_"+b[e].id_str).show(),$("#friendMessagesToggleLink_"+b[e].id_str).html("hide conversation"))}0<a.length&&$("#friendsContainer").prepend(Handlebars.getTemplate("conversations-template")(a))}},
updateDirectMessagesUI:function(a,b){app.hideOverlays();b=b?b:app.getFriendsFromMessageList(a);app.renderAllFriendMessages(b,a);app.updatingDirectMessages=!1},markMessageableFriends:function(a){var b=app.getObject("publicKeys-"+app.activeUser.user.id_str),c;for(c in a)a[c].publicKey=b[a[c].id_str]},markFriendsWithSentKeys:function(a){var b=app.getObject("sentPublicKeys-"+app.activeUser.user.id_str),c;for(c in b)for(var d in a)c==a[d].id_str&&(a[d].sentKey=b[c])},markFriendsWithUnencryptedMessages:function(a,
b){for(var c in a){a[c].unencryptedMessages=!1;for(var d in b)if(b[d].encrypted&&!b[d].encryptionSuccessful){a[c].unencryptedMessages=!0;break}}},renderAllFriendMessages:function(a,b){for(var c in a)app.renderFriendMessages(a[c].id_str,b)},renderFriendMessages:function(a,b){var c=app.filterMessageListByFriendId(b,a);if(app.dmPostData.since_id){for(var d in c)c[d].new=!0;$("#friendMessages_"+a).prepend(Handlebars.getTemplate("direct-messages-template")(c))}else $("#friendMessages_"+a).append(Handlebars.getTemplate("direct-messages-template")(c))},
getFriendsFromMessageList:function(a){var b={},c;for(c in a)b[a[c].sender.screen_name]||(b[a[c].sender.screen_name]=a[c].sender,b[a[c].sender.screen_name].most_recent=a[c]),b[a[c].sender.screen_name].message_count||(b[a[c].sender.screen_name].message_count=0),b[a[c].sender.screen_name].message_count++;a=[];for(f in b)a.push(b[f]);return a},toggleFriendMessages:function(a){"show conversation"!=$("#friendMessagesToggleLink_"+a).html()?($("#friendMessagesToggleLink_"+a).html("show conversation"),$("#friendMessageForm_"+
a).fadeOut(),$("#friendMessages_"+a).fadeOut()):($("#friendMessagesToggleLink_"+a).html("hide conversation"),$("#friendMessageForm_"+a).fadeIn(),$("#friendMessages_"+a).fadeIn())},filterMessageListByFriendId:function(a,b){var c=[],d;for(d in a)a[d].sender.id_str!=b&&a[d].sender.id_str!=app.activeUser.id_str||c.push(a[d]);return c},getOlderDirectMessages:function(){app.hasFirstDirectMessage||(app.setupDMPostData(),app.dmPostData.max_id=app.dmMaxId,app.doDMPost(app.dmPostData,function(a){if(a.length<
app.NUM_DM||app.dmMaxId==a[a.length-1].id_str)app.hasFirstDirectMessage=!0,$("#directMessages").append(Handlebars.getTemplate("no-more-direct-messages-template")()),$("#getOlderMessagesButton").hide();app.handleDMResponse(a)}))},isPublicKey:function(a){return app.publicKeyStartRegex.test(a)&&app.publicKeyEndRegex.test(a)},isPGPMessage:function(a){return app.pgpMessageStartRegex.test(a)&&app.pgpMessageEndRegex.test(a)},timelineContainsKeys:function(a){for(var b in a)if(app.isPublicKey(a[b].seecret))return!0;
return!1},timelineContainsEncryptedMessages:function(a){for(var b in a)if(app.isPGPMessage(a[b].seecret))return!0;return!1},getPublicKeyMessagesFromDMList:function(a){var b=[],c;for(c in a)app.isPublicKey(a[c].seecret)&&b.push(a[c]);return b},savePublicKeys:function(a){var b=app.activeUser.publicKeys;null==b&&(b={});var c={},d;for(d in a)a[d].sender.id_str!=app.activeUser.user.id&&(c[a[d].sender.id_str]||(c[a[d].sender.id_str]={key:a[d].seecret,screen_name:a[d].sender.screen_name,id_str:a[d].sender.id_str,
profile_image_url:a[d].sender.profile_image_url,receiveDate:a[d].created_at}));for(var e in c)b[e]||$("#friendKeyContainer_"+e).html("Just sent you their key!"),b[e]=c[e];app.saveObject("publicKeys-"+app.activeUser.user.id_str,b);app.activeUser.publicKeys=b},markEncryptedDirectMessages:function(a){for(var b in a)this.isPGPMessage(a[b].seecret)&&(a[b].encrypted=!0,a[b].decrypted=!1)},sendPublicKeyMessages:function(a,b){app.postDirectMessages(a,function(){app.trackSentPublicKeys(b)})},trackSentPublicKeys:function(a){var b=
app.activeUser.sentPublicKeys;null==b&&(b={});for(var c in a)b[c]=new Date;app.activeUser.sentPublicKeys=b;app.saveObject("sentPublicKeys-"+app.activeUser.user.id_str,b)},decryptDirectMessages:function(a){app.timer("decryptDirectMessages");var b=openpgp.key.readArmored(app.activeUser.privateKey.armored).keys[0];if(app.decryptPrivateKey(b))app.verifyMessagesDecrypted(a,b);else{alert("Could not verify your passphrase.  Showing messages undecrypted.");for(var c in a)a[c].encrypted&&(a[c].text+=" (could not decrypt)");
app.updateDirectMessagesUI(a)}},verifyMessagesDecrypted:function(a,b){var c=null,d;for(d in a)if(a[d].encrypted&&0==a[d].decrypted){c=d;break}var e=app.activeUser.user;if(null!=c)if(a[c].sender.id_str==e.id)a[c].decrypted=!0,app.verifyMessagesDecrypted(a,b);else{a[c].decrypted=!0;a[c].decryptionSuccessful=!1;a[c].originaltext=a[c].text;try{var g=openpgp.message.readArmored(a[c].seecret),h={privateKey:b,message:g};if(app.activeUser.publicKeys&&app.activeUser.publicKeys[a[c].sender.id_str]){var k=openpgp.key.readArmored(app.activeUser.publicKeys[a[c].sender.id_str].key);
h.publicKeys=k.keys}try{openpgp.decrypt(h).then(function(b){a[d].decryptionSuccessful=!0;a[d].seecret=b.data;b.signatures&&0<b.signatures.length&&b.signatures[0].valid&&(a[d].signed=!0);app.verifyMessagesDecrypted(a,h.privateKey)},function(b){a[d].text=app.generateUndecryptedMessageContent(a[d]);app.verifyMessagesDecrypted(a,h.privateKey)})}catch(m){console.log("try/catch error decrypting: "+JSON.stringify(m)),a[d].text=app.generateUndecryptedMessageContent(a[d]),app.verifyMessagesDecrypted(a,b)}}catch(m){console.log("major try/catch error decrypting: "+
JSON.stringify(m)),a[d].text=app.generateUndecryptedMessageContent(a[d]),app.verifyMessagesDecrypted(a,b)}}else{(c=app.activeUser.dmSenders)||(c={});for(var l in a)a[l].encrypted&&a[l].sender.id_str!=app.activeUser.id&&(c[a[l].sender.id_str]=!0);app.saveObject("dmSenders-"+app.activeUser.user.id_str,c);app.refreshActiveUserDMSenders();app.timer("decryptDirectMessages");app.timer("updateDirectMessagesUI");app.createConversationEntries(a);app.updateDirectMessagesUI(a);app.timer("updateDirectMessagesUI")}},
undecryptedMessageContentHandler:null,generateUndecryptedMessageContent:function(a){return Handlebars.getTemplate("undecrypted-message-content-template")(a)},showPublicKeyManager:function(a,b){app.doScroll=!1;var c={};c.receiver_name=b;c.receiver_id=a;$("#directMessagesActionsContainer").html(Handlebars.getTemplate("public-key-template")(c))},showWaitingForPublicKeyView:function(a,b){app.doScroll=!1;var c={};c.receiver_name=b;c.receiver_id=a;c.invite_date=moment(app.activeUser.sentPublicKeys[a]).format("MMMM Do YYYY, h:mm:ss a");
$("#directMessagesActionsContainer").html(Handlebars.getTemplate("public-key-pending-template")(c))},showDirectMessageForm:function(a,b){app.doScroll=!1;var c={receiverId:a,receiverName:b};$("#directMessagesActionsContainer").html(Handlebars.getTemplate("direct-message-template")(c));app.doScroll=!1},makeKeyOptionsForUser:function(a){var b=app.generatePassword(),c=1024;openpgp.util.getWebCryptoAll()&&(c=2048);return{numBits:c,userIds:[{name:a.name,email:a.screen_name+"@seecretApp.seecret"}],passphrase:b}},
generatePassword:function(){for(var a="",b=0;50>b;b++)a+=app.getValidPasswordCharacter();return a},getValidPasswordCharacter:function(){for(;;){var a=Math.floor(206*Math.random())+48;if(!(173==a||92==a||58<=a&&64>=a||127<=a&&160>=a))return String.fromCharCode(a)}},validateNewPrivateKey:function(a){if(1>$("#"+a).val().length)return $("#"+a+"Error").html("You must have a passphrase for your key of at least one character"),!1;$("#"+a+"Error").html("");if(confirm("Are you sure?")){var b=$("#"+a).val(),
c=1==document.getElementById(a+"Cache").checked;app.hideAllViews();$("#"+app.STATUS_MESSAGE_VIEW).show();app.generatePrivateKeyPair(b,c,function(){$("#"+a).val("");confirm("Send your new key to the contacts who have the old one?")&&app.resendPublicKeys();$("#directMessagesActionsContainer").empty();app.renderPrivateKeySettings();app.setView(app.SETTINGS_VIEW)})}},resendPublicKeys:function(){var a=app.activeUser.sentPublicKeys,b=app.activeUser.dmSenders;if(null!=a||null!=b){var c=[],d={},e;for(e in a)d[e]=
!0;for(e in b)d[e]=!0;var a=0,g;for(g in d){a++;var b=app.generatePublicKeyMessages(g),h;for(h in b)c.push({receiverId:g,text:b[h]})}0<c.length&&app.sendPublicKeyMessages(c,d)}},generatePrivateKeyPair:function(a,b,c){var d=app.activeUser.user,e=app.makeKeyOptionsForUser(d);e.passphrase=a;d.id_str||(e.userId=d.id_str);null!=d&&(a=new Date,console.log("start generating key pair : "+a.getSeconds()+":"+a.getMilliseconds()),openpgp.config.debug=!0,openpgp.generateKey(e).then(function(a){var d=new Date;
console.log("done generating key pair : "+d.getSeconds()+":"+d.getMilliseconds());app.generatePrivateKeyPairSuccess(a,e,b,c)}).catch(function(a){console.log("Caught an error generatinga key pair");console.log(JSON.stringify(a))}))},generatePrivateKeyPairSuccess:function(a,b,c,d){c||delete b.passphrase;c=app.activeUser.user;var e=new Date,g={};g.armored=a.privateKeyArmored;g.dateCreated=e;var h={};h.armored=a.publicKeyArmored;h.dateCreated=e;app.saveObject("keyOptions-"+c.id_str,b);app.saveObject("privateKey-"+
c.id_str,g);app.saveObject("publicKey-"+c.id_str,h);app.checkDirectMessageStatus();app.refreshActiveUserTotal();d()},showAllDirectMessages:function(){$(".friendMessages").show()},invite:function(a,b){var c=app.generatePublicKeyMessages(a),d=[],e;for(e in c)d.push({receiverId:a,text:c[e]});b||d.push({text:app.joinMessage,receiverId:a});app.overlay();app.postDirectMessages(d,function(){var b={};b[a]=!0;app.trackSentPublicKeys(b);$("#friendKeyContainer_"+a).html("Invite sent.")})},prepareDirectMessage:function(a){if(!app.sendingDirectMessage){var b=
$("#directMessage_"+a).val();0!=b.length&&($("#directMessage_"+a).val(""),app.sendingDirectMessage=!0,app.overlay(),app.encryptDirectMessage(b,a))}},decryptPrivateKey:function(a){var b=app.activeUser.keyOptions,c=null;app.passphrase&&(c=app.passphrase);b.passphrase&&(c=b.passphrase);b.passphrase||null!=app.passphrase||(app.passphrase=c=prompt("Enter your passphrase"));if(a.decrypt(c))return!0;app.passphrase=null;return!1},encryptDirectMessage:function(a,b){var c=app.activeUser.publicKeys,d=null,e;
for(e in c)e==b&&(d=c[e].key);d?(c=openpgp.key.readArmored(d).keys,c={publicKeys:c,data:a},app.activeUser.privateKey&&(d=openpgp.key.readArmored(app.activeUser.privateKey.armored),app.decryptPrivateKey(d.keys[0])&&(c.privateKeys=d.keys)),openpgp.encrypt(c).then(function(a){a=app.hideAndCompress(a.data);app.seecret_engine.config.RANDOM_COVERTEXTS=!0;app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=1E4;a=app.seecret_engine.chainify(a,covertexts);app.seecret_engine.config.RANDOM_COVERTEXTS=!1;app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=
140;a.reverse();for(var c in a)a[c]={receiverId:b,text:a[c]};app.postDirectMessages(a,function(){});$("#directMessage").val("")}).catch(function(a){console.log("Error generating the messages:"+JSON.stringify(a));app.hideOverlays();app.sendingDirectMessage=!1})):(app.sendingDirectMessage=!1,app.hideOverlays(),alert("You do not have that users public key."))},postDirectMessages:function(a,b){app.overlay();app.directMessagesToPost=a;app.directMessageCount=0;app.checkDirectMessages(b)},checkDirectMessages:function(a){if(app.directMessagesToPost&&
app.directMessageCount<app.directMessagesToPost.length){var b=app.directMessagesToPost[app.directMessageCount].text,c=app.directMessagesToPost[app.directMessageCount].receiverId;app.directMessageCount++;app.postDirectMessage(b,c,a)}else app.hideOverlays(),alert("Sent!"),app.sendingDirectMessage=!1,a&&a()},postDirectMessage:function(a,b,c){app.oauthResult.post("1.1/direct_messages/new.json",{data:{text:a,user_id:b}}).done(function(a){app.checkDirectMessages(c)}).fail(function(a){})},generatePublicKeyMessages:function(a){a=
app.activeUser.publicKey;if(null!=a)return a=app.hideAndCompress(a.armored),app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=1E4,chain=app.seecret_engine.chainify(a,["Here's my Seecret key","Now we can start using Seecret to send encrypted messages on Twitter."]),chain.reverse(),app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH=140,chain},promptDeleteKey:function(){confirm("Are you sure?")&&(app.deleteSavedItem("privateKey-"+app.activeUser.user.id_str),app.deleteSavedItem("publicKey-"+app.activeUser.user.id_str),
app.deleteSavedItem("keyOptions-"+app.activeUser.user.id_str),app.activeUser.privateKey=null,app.activeUser.publicKey=null,app.activeUser.keyOptions=null,app.renderPrivateKeySettings(),app.setView(app.SETTINGS_VIEW))},openDirectMessageForm:function(a){$("#friendMessageForm_"+a).fadeIn()},checkDirectMessageStatus:function(){app.doScroll=!1;var a=$("#selectedReceiverId").val(),b=$("#selectedReceiverName").val();if(a)if(null==app.activeUser.privateKey)app.showPrivateKeyManager();else{var c=app.activeUser.publicKeys,
d=app.activeUser.sentPublicKeys;null==d||null==d[a]||null!=c&&c[a]?null==c||null!=c&&!c[a]?app.showPublicKeyManager(a,b):app.showDirectMessageForm(a,b):app.showWaitingForPublicKeyView(a,b);app.doScroll=!0}},updateUserTimeline:function(a,b){b&&(app.maxId=null);app.userTimelineId=a;app.homeTimeline=!1;app.updatingTimeline=!0;var c={data:{}};c.data.count=200;c.data.screen_name=a;c.data.include_rts=!1;null!=app.maxId?c.data.max_id=app.maxId:$("#status-list").empty();app.hideOverlays();app.getUserTimeline(c,
app.handleTimelineResponse)},getTimeline:function(a,b){app.oauthResult.get("1.1/statuses/home_timeline.json",a).done(function(a){b(a);app.hideOverlays()}).fail(app.handleGetTimelineError)},getUserTimeline:function(a,b){$("#twitterUser").val("");app.oauthResult.get("1.1/statuses/user_timeline.json",a).done(function(a){b(a);app.hideOverlays()}).fail(app.handleGetTimelineError)},handleTimelineResponse:function(a){app.timer("Get timeline");0<a.length?1==a.length&&a[0].id_str==app.maxId?($("#status-list").append(Handlebars.getTemplate("no-more-timeline-message-template")()),
$("#getOlderTimelineButton").hide()):(app.timer("Process timeline Response"),app.processTimelineResponse(a),app.timer("Process timeline Response")):app.handleEmptyTimelineResponse(a)},handleGetTimelineError:function(a){429==a.status?alert("Twitter rate limit exceeded.  You must wait 15 minutes to make more requests from this app."):404==a.status?alert("Twitter says that screen name does not exist."):alert("There was an error retrieving the timeline.");console.log("Error:"+JSON.stringify(a));app.hideOverlays()},
handleEmptyTimelineResponse:function(a){app.hideOverlays()},processTimelineResponse:function(a){app.addFollowerTagToTweets(a,app.processTimelineWithFollowerInfo)},addFollowerTagToTweets:function(a,b){var c={},d;for(d in a)c[a[d].user.id_str]=a[d].user.id_str;d=[];for(var e in c)d.push(e);c={data:{}};c.data.user_id=d.join();app.oauthResult.get("1.1/friendships/lookup.json",c).done(function(c){var d={},e;for(e in c)0<=c[e].connections.indexOf("followed_by")&&(d[c[e].id_str]=!0);for(var l in a)d[a[l].user.id_str]&&
(a[l].follower=!0);b(a)}).fail(function(c){b(a)})},unhideAndDecompressSeecretsInList:function(a,b){var c=[],d;for(d in a)if(a[d].seecret_envelope||!document.getElementById("showOnlySeecrets").checked)if(a[d].seecret_envelope){var e=a[d].seecret_envelope,g=app.seecret_engine.getSeecretFromEnvelope(e),e=app.seecret_engine.getContentTypeFromEnvelope(e),g=app.seecret_engine.unhide(g,e);if(e==app.seecret_engine.config.CONTENT_TYPES.NUMBERS_ARRAY)try{g=seecret_compression.decompress(g),a[d].seecret=g}catch(h){a[d].seecret=
"Could not decompress the Seecret",a[d].seecret_error=h}else a[d].seecret=g;c.push(a[d])}else b&&!app.seecret_engine.hasSeecretContent(a[d].text)&&c.push(a[d]);return c},unhideAndDecompressTimelineSeecrets:function(a,b){var c=[],d;for(d in a)if(a[d].seecret_envelope){var e=a[d].seecret_envelope,g=app.seecret_engine.getSeecretFromEnvelope(e),e=app.seecret_engine.getContentTypeFromEnvelope(e),g=app.seecret_engine.unhide(g,e);if(e==app.seecret_engine.config.CONTENT_TYPES.NUMBERS_ARRAY)try{g=seecret_compression.decompress(g),
a[d].seecret=g}catch(h){console.log("error decompressing a seecret message: "+JSON.stringify(h)),a[d].seecret="Could not decompress the Seecret",a[d].seecret_error=h}else a[d].seecret=g;c.push(a[d])}else b&&!app.seecret_engine.hasSeecretContent(a[d].text)&&c.push(a[d]);return c},getEarliestIncompleteChainStartId:function(a,b){for(var c in b)app.getFirstIncompleteChainStart(a,b[c])},getEarliestIncompleteDMChainStartId:function(a,b){for(var c in b)app.getFirstIncompleteDMChainStart(a,b[c])},getFirstIncompleteChainStart:function(a,
b){var c=0,d;for(d in a)a[d].user.id_str==b&&app.seecret_engine.hasSeecretContent(a[d].text)&&(app.seecret_engine.isEnvelopeStart(a[d].text)&&(c=d),app.seecret_engine.isEnvelopeEnd(a[d].text)&&(c=0));return c},getFirstIncompleteDMChainStart:function(a,b){var c=0,d;for(d in a)a[d].sender.id_str==b&&app.seecret_engine.hasSeecretContent(a[d].text)&&(app.seecret_engine.isEnvelopeStart(a[d].text)&&(c=d),app.seecret_engine.isEnvelopeEnd(a[d].text)&&(c=0));return c},getFirstIncompleteChainStart:function(a,
b){var c=0,d;for(d in a)b(a[d])[senderProp].sender.id_str==userId&&app.seecret_engine.hasSeecretContent(timeline[t].text)&&(app.seecret_engine.isEnvelopeStart(timeline[t].text)&&(c=t),app.seecret_engine.isEnvelopeEnd(timeline[t].text)&&(c=0));return c},processMessageList:function(a,b,c){var d=function(a){return a[b]?a[b].id_str:null},e=app.getUniqueInstancesFromList(a,d),g=app.getMessageIndexes(a,e,d);a=app.dechainifyMessages(a,g,b);app[c]=app.lastProcessedStatusId=a[a.length-1].id_str;var g=0,h;
for(h in e){var e=0,k;for(k in a)d(a[k])==h&&app.seecret_engine.hasSeecretContent(a[k].text)&&(app.seecret_engine.isEnvelopeStart(a[k].text)&&(e=k),app.seecret_engine.isEnvelopeEnd(a[k].text)&&(e=0));0<e&&0==g?g=e:0<e&&e<g&&(g=e)}d=g;0<d&&(app[c]=a[d].id_str);a=app.unhideAndDecompressSeecretsInList(a,!0);for(k in a)a[k][b]&&a[k][b].profile_image_url&&(a[k][b].profile_image_url=a[k][b].profile_image_url.replace(app.httpsReplaceRegex,"https:"));return a},processTimelineWithFollowerInfo:function(a){var b=
null;app.dmPost&&app.dmPost.since_id&&app.dmMaxId&&(b=app.dmMaxId);a=app.processMessageList(a,"user","maxId");b&&(app.dmMaxId=b);0<a.length?$("#status-list").append(Handlebars.getTemplate("status-template")(a)):document.getElementById("showOnlySeecrets").checked&&$("#status-list").append(Handlebars.getTemplate("no-seecrets-in-timeline-segment-template")());$(".basicTweet").fadeIn();app.updatingTimeline=!1;app.userTimelineId?app.renderUserTimelineHeader(app.userTimelineId):$("#timelineName").html("")},
renderUserTimelineHeader:function(a){$("#timelineName").html("for "+a+" &nbsp;&nbsp;&nbsp;<a href='javascript:app.initTimeline();app.updateHomeTimeline()'>Back to my timeline</a>")},dechainifyMessages:function(a,b,c){for(var d in b)if(0<b[d].length){var e=function(a){return a&&a.text&&"string"==typeof a.text&&a[c]&&a[c].id_str==d?a:null},g=0,h;for(h in b[d]){var k=app.seecret_engine.dechainify(a,{chainSegmentMatcher:e,chainSegmentContentFinder:this.chainSegmentContentFinder,startIndex:b[d][h],withCovertexts:!0});
k&&""!=k.seecret&&(a[b[d][h]].seecret_envelope=k.seecret,a[b[d][h]].covertexts=k.covertexts);g++}}return a},chainSegmentContentFinder:function(a){return a.text},tweetSenderGetter:function(a){return a.user?a.user.id_str:null},dmSenderGetter:function(a){return a.user?a.user.id_str:null},getMessageIndexes:function(a,b,c){var d={},e;for(e in b)d[e]=app.seecret_engine.getOrdinalIndexes(a,{chainSegmentMatcher:function(a){return c(a)==b[e]?a:null},chainSegmentContentFinder:this.chainSegmentContentFinder});
...
a.sender.id_str==b[d]?a:null},chainSegmentContentFinder:this.chainSegmentContentFinder});return c},getUniqueTweeters:function(a){return app.getUniqueInstancesFromList(a,app.getTweeterId)},getUniqueDMSenders:function(a){return app.getUniqueInstancesFromList(a,app.getDMSenderId)},getTweeterId:function(a){return a.user.id_str},getDMSenderId:function(a){return a.sender.id_str},getUniqueInstancesFromList:function(a,b){var c={},d;for(d in a){var e=b(a[d]);e&&(c[e]=e)}return c},generateTimelinePostVals:function(){var a=
{data:{}};a.data.count=200;null!=app.maxId&&(a.data.max_id=app.maxId);return a},initTimeline:function(){app.maxId=null;app.homeTimeline=!0;app.userTimelineId=null;app.updateHomeTimeline()},updateHomeTimeline:function(a){$("#twitterUser").val("");a&&(app.maxId=null);app.homeTimeline=!0;$("#timelineName").empty();app.updatingTimeline=!0;a=app.generateTimelinePostVals();a.data.max_id||($("#status-list").empty(),app.lastProcessedStatusId=null);app.overlay();app.timer("Get timeline");app.getTimeline(a,
app.handleTimelineResponse)},prepareUpdateMessage:function(){var a=$("#textarea-statusUpdate").val(),a=app.hideAndCompress(a),b=null;app.useAutogeneratedScaffolding()||(b=app.getScaffolds());a=app.seecret_engine.chainify(a,b);a.reverse();return a},updateStatus:function(){app.overlay();var a=this.prepareUpdateMessage();this.postChain(a)},postChain:function(a){this.currentMessageChain=a;this.chainCount=0;this.postChainItem()},postChainItem:function(){this.chainCount<this.currentMessageChain.length?
app.oauthResult.post("1.1/statuses/update.json",{data:{status:this.currentMessageChain[this.chainCount++]}}).done(function(a){setTimeout(function(){app.postChainItem()},50)}).fail(function(a){}):($("#status-list").empty(),$("#scaffoldingWarningContainer").empty(),$("#scaffoldingStatus").empty(),$("#textarea-statusUpdate").val(""),$("#textarea-statusUpdate").val(""),$("#scaffoldsContainer").html(Handlebars.getTemplate("scaffolds-template")()),$("#scaffoldingContainer > div > div > input").val(""),
...
$("#importPrivateKeyPassphrase").val("");$("#privateKeyTextarea").val("");$("#privateKeyPassphrase").val("");$("#privateKeyCopyarea").empty();$("#publicKeysDisplayArea").empty();app.unauthenticatedHeader();$("#privateMessagesButton").hide();$("#timelineButton").hide();app.unauthenticatedMenu();app.setView(app.ABOUT_VIEW);app.hideOverlays()},authenticatedMenu:function(){$("#privateMessagesButton").show();$("#timelineButton").show();$("#settingsButton").show();$("#logoutButton").show();$("#hashesButton").show();
$("#publicKeysButton").show();$("#aboutButton").show()},unauthenticatedMenu:function(){$("#privateMessagesButton").hide();$("#timelineButton").hide();$("#settingsButton").hide();$("#logoutButton").hide();$("#publicKeysButton").hide()},authenticatedHeader:function(){app.activeUser&&app.activeUser.user&&(app.activeUser.user.profile_image_url=app.activeUser.user.profile_image_url.replace(app.httpsReplaceRegex,"https:"),$("#loginContainer").html(Handlebars.getTemplate("authenticated-header-template")(app.activeUser.user)))},
unauthenticatedHeader:function(){$("#loginContainer").html(Handlebars.getTemplate("unauthenticated-header-template")())},hideAllViews:function(){$("#timeline").hide();$("#statusMessage").hide();$("#privateMessages").hide();$("#settings").hide();$("#publicKeys").hide();$("#about").hide();$("#hashes").hide()},setMenuState:function(a){$.each($(".menuLink"),function(a,c){$(this).css("background","");$(this).css("color","")});$("#"+a).css("background","#e3e3e3");$("#"+a).css("color","#333");app.openClosePanel("close")},
setView:function(a){app.doScroll=!1;app.hideAllViews();$("#"+a).fadeIn(function(){app.doScroll=!0}).css("display","block");app.setMenuState(a+"Button")},renderPublicKeys:function(){var a=app.activeUser.publicKeys,b=[],c=0,d;for(d in a)a[d].displayDate=moment(a[d].receiveDate).format("MMMM Do YYYY, h:mm:ss a"),b.push(a[d]),c++;0<c?(a=Handlebars.getTemplate("public-keys-template")({keys:b}),$("#publicKeysDisplayArea").html(a)):$("#publicKeysDisplayArea").html("No public keys")},copySenderPublicKeyToClipboard:function(a){var b=
app.activeUser.publicKeys;b[a]&&(executeCopy(b[a].key),alert(b[a].screen_name+"'s key has been copied to your clipboard"))},copyContentsToClipboard:function(a){executeCopy($("#"+a).html())},showPrivateKeyManager:function(){app.doScroll=!1;$("#directMessagesActionsContainer").html(Handlebars.getTemplate("private-key-template")());$("#directMessagesActionsContainer").show()},openClosePanel:function(a){"open"==a?$("#left-panel").css("left",0):$("#left-panel").css("left","-14em")},processScaffoldField:function(a){a=
$("#scaffold"+a);val=a.val();for(var b=val.replace(/\s{2,}/g," ");" "==b.substr(0,1);)b=b.substr(1);b=b.substr(0,100);b!=val&&a.val(b)},useAutogeneratedScaffolding:function(){return!1},hideAndCompress:function(a){var b=app.seecret_engine.hide(a,app.seecret_engine.config.CONTENT_TYPES.PLAIN),b=app.seecret_engine.envelope(b,app.seecret_engine.config.CONTENT_TYPES.PLAIN);a=seecret_compression.compress(a);a=app.seecret_engine.hide(a,app.seecret_engine.config.CONTENT_TYPES.NUMBERS_ARRAY);a=app.seecret_engine.envelope(a,
app.seecret_engine.config.CONTENT_TYPES.NUMBERS_ARRAY);return b.length>a.length?a:b},processScaffolding:function(){var a=$("#textarea-statusUpdate").val();if(!app.useAutogeneratedScaffolding()){var b=!1,a=app.hideAndCompress(a),c=app.getScaffolds(),d=0,e=0;if(1==c.length)if(2<=c[0].trim().length&&c[0].trim().length+a.length<app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH)b=!0,d=app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH-a.length-c[0].trim().length;else{if(2>c[0].trim().length){app.makeUpdateFormPending();
return}e=app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH-(c[0].trim().length+a.length);e*=-1}else{var g=scaffoldLength=0;for(each in c)2<=c[each].trim().length&&(scaffoldLength+=c[each].trim().length,g++);scaffoldLength+a.length<app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH*g?(b=!0,d=app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH*g-(scaffoldLength+a.length)):(e=app.seecret_engine.config.MAX_CHAIN_SEGMENT_LENGTH*g-(scaffoldLength+a.length),e*=-1)}b?app.makeUpdateFormReady(d):app.makeUpdateFormNotReady(e)}},
newVisibleMessageField:function(){var a=app.getScaffolds();app.addScaffoldField(a.length);app.processScaffolding()},addScaffoldField:function(a,b){var c={scaffoldId:a,val:b,scaffoldCount:a+1};$("#scaffoldsContainer").append(Handlebars.getTemplate("scaffold-template")(c))},makeUpdateFormReady:function(a){$("#submitButtonContainer").show();var b={};b.availableCharacters=a;$("#scaffoldingStatus").html(Handlebars.getTemplate("scaffold-status-good-template")(b))},makeUpdateFormNotReady:function(a){$("#submitButtonContainer").hide();
var b={};b.spillover=a;$("#scaffoldingStatus").html(Handlebars.getTemplate("scaffold-status-spillover-template")(b))},makeUpdateFormPending:function(){$("#submitButtonContainer").hide();$("#scaffoldingStatus").html(Handlebars.getTemplate("scaffold-status-incomplete-template")())},removeScaffold:function(a){var b=app.getScaffolds(),c=[],d;for(d in b)d!=a&&c.push(b[d]);app.renderScaffolds(c);app.processScaffolding()},renderScaffolds:function(a){$("#scaffoldsContainer").html("");for(var b=0,c=0;c<a.length;c++)app.addScaffoldField(b++,
a[c]);$("#scaffoldRemover0").remove()},getScaffolds:function(){for(var a=[],b=document.getElementById("scaffold0");b;)a.push(b.value.trim()),b=document.getElementById("scaffold"+a.length);return a},toggleScaffolds:function(){document.getElementById("scaffoldingOption").checked?($("#scaffoldingStatus").html(""),$("#scaffoldsContainer").html(""),$("#scaffoldingWarningContainer").hide(),$("#scaffoldingContainer").hide(),$("#submitButtonContainer").show()):($("#scaffoldingStatus").html(""),$("#scaffoldsContainer").html(""),
$("#scaffoldingContainer").show(),$("#scaffoldingWarningContainer").html(""),$("#submitButtonContainer").hide(),app.addScaffoldField(0),app.processScaffolding())},getScaffoldTotal:function(a){for(var b=0,c=0;c<a.length;c++)b+=a[c].trim().length;return b},showCopyPrivateKey:function(a){"block"==$("#privateKeyCopyarea").css("display")?($(a).html("Show"),$("#privateKeyCopyarea").hide(),$("#privateKeyCopyarea").html("")):($(a).html("Hide"),app.renderPrivateKeySettings())},toggleDeleteSettings:function(a){"block"==
$("#deleteKeyForm").css("display")?($(a).html("Show"),$("#deleteKeyForm").hide()):($(a).html("Hide"),$("#deleteKeyForm").show())},renderPrivateKeySettings:function(){var a=app.activeUser.privateKey,b=app.activeUser.publicKey,c=app.activeUser.keyOptions,d={};app.activeUser&&app.activeUser.privateKey&&(d.privateKey=a,d.privateKey.dateCreatedDisplay=(new moment(d.privateKey.dateCreated)).format("MMMM Do YYYY, h:mm:ss a"),d.publicKey=b,d.keyOptions=c);a=Handlebars.getTemplate("user-keys-template")(d);
$("#privateKeyCopyarea").html(a);$("#privateKeyCopyarea").fadeIn()},showPublicKeys:function(a){"block"==$("#publicKeysDisplayArea").css("display")?($(a).html("Show"),$("#publicKeysDisplayArea").hide()):($(a).html("Hide"),app.renderPublicKeys(),$("#publicKeysDisplayArea").fadeIn())},showImportPrivateKey:function(a){"block"==$("#importForm").css("display")?($(a).html("Show"),$("#importForm").hide()):($(a).html("Hide"),$("#importForm").show())},showGeneratePrivateKey:function(a){"block"==$("#generateForm").css("display")?
($(a).html("Show"),$("#generateForm").hide()):($(a).html("Hide"),$("#generateForm").show())},saveObject:function(a,b){localStorage[a]=JSON.stringify(b)},getObject:function(a){return app.getLocalObject(a)},getLocalObject:function(a){return localStorage[a]?JSON.parse(localStorage[a]):null},saveLocalObject:function(a,b){localStorage[a]=JSON.stringify(b)},deleteSavedItem:function(a){delete localStorage[a]},importPrivateKey:function(){var a=app.activeUser.user,b=$("#importPrivateKeyText").val(),c=new Date,
d=openpgp.key.readArmored(b);if(!d||!d.keys||1>d.keys.length)alert("The key is invalid");else{var e=openpgp.key.readArmored(b).keys[0],g=$("#importPrivateKeyPassphrase").val();e.decrypt(g)?(g=$("#importPrivateKeyPassphrase").val(),$("#importPrivateKeyText").val(""),$("#importPrivateKeyPassphrase").val(""),d=app.makeKeyOptionsForUser(a),d.passphrase=g,b={armored:b,dateCreated:c},c={armored:e.toPublic().armor(),dateCreated:c},app.activeUser.privateKey=b,app.activeUser.publicKey=c,app.activeUser.keyOptions=
d,app.saveObject("privateKey-"+a.id_str,b),app.saveObject("publicKey-"+a.id_str,c),app.saveObject("keyOptions-"+a.id_str,d),app.activeUser.privateKey=b,app.activeUser.publicKey=c,app.activeUser.keyOptions=d,app.renderPrivateKeySettings(),confirm("Successfully imported the private key. Send your new key to the contacts who have the old one?")&&app.resendPublicKeys()):alert("Could not decrypt the key with the passphrase you entered.  Please try again")}},deleteSavedPassphrase:function(){if(confirm("Are you sure?")){var a=
app.activeUser.user,b=app.activeUser.keyOptions;b.passphrase="";app.activeUser.keyOptions=b;app.saveObject("keyOptions-"+a.id_str,b)}app.renderPrivateKeySettings()},changePassphrase:function(){var a=prompt("Enter new passphrase");if(null!=a){var b=prompt("Enter it again");null!=b&&(a==b?(alert("Changing your passphrase to "+b+"\n we urge you to delete it from this device once you've got it memorized or saved elsewhere."),app.setNewPassphraseOnPrivateKey(a)):alert("Your new passphrase did not match, please try again"))}app.renderPrivateKeySettings()},
setNewPassphraseOnPrivateKey:function(a){var b=app.activeUser.user,c=app.activeUser.keyOptions,d=openpgp.key.readArmored(app.activeUser.privateKey.armored);if(app.decryptPrivateKey(d.keys[0])){d.keys[0].primaryKey.encrypt(a);d.keys[0].subKeys&&0<d.keys[0].subKeys.length&&d.keys[0].subKeys[0]&&d.keys[0].subKeys[0].subKey.encrypt(a);var e={};e.dateCreated=new Date;e.armored=d.keys[0].armor();var g={};g.dateCreated=new Date;g.armored=d.keys[0].toPublic().armor();c.passphrase=a;app.saveObject("publicKey-"+
...
[];a=a.split(b);for(var e in a)b=a[e].split(c),d.push({name:b[0],value:b[1]});return d},isIOS:function(){return/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream},timer:function(a){var b=moment();app.timers[a]?(console.log(a+" took "+b.diff(app.timers[a])+" milliseconds"),delete app.timers[a]):app.timers[a]=b}};
...
$(window).scrollTop(),b=$(window).height(),c=$(document).height();a+b==c&&("block"!=document.getElementById("timeline").style.display||app.updatingTimeline?document.getElementById("privateMessages"):app.homeTimeline?app.updateHomeTimeline():app.updateUserTimeline(app.userTimelineId))}});window.onpopstate=function(a){document.location.hash&&app.setViewFromHash(document.location.hash)};$("#textarea-statusUpdate").keyup(function(a){app.processScaffolding()});$("#textarea-statusUpdate").change(function(a){app.processScaffolding()});
$("#scaffoldingEntryContainer0").keyup(function(a){app.processScaffoldField(0);app.processScaffolding()});$("#updateStatusForm").submit(function(a){a.preventDefault();app.updateStatus()});$("#hashesContent").html(Handlebars.getTemplate("hashes-template")(hashes));app.initialize()});Handlebars.registerHelper("tweetShortDate",function(a){a=moment(a,"dd MMM DD HH:mm:ss ZZ YYYY","en").twitter();a.match(/\//)||(a+=" ago");return a});
