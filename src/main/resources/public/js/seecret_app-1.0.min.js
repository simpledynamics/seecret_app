...
(d=c.profile_image_url||(null!=a?a.profile_image_url:a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"profile_image_url",hash:{},data:e}):d))+'" class="profileImg" />\r\n\t</div>\r\n\t<div class="dm_profileCopy" style="">\r\n\t\t<div id="conversationInfoDiv_'+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"id_str",hash:{},data:e}):d))+'">\r\n'+(null!=(b=c["if"].call(a,null!=a?a.message_count:a,{name:"if",hash:{},fn:f.program(1,
e,0),inverse:f.program(4,e,0),data:e}))?b:"")+'\t\t</div>\r\n\t\t<div id="friendKeyContainer_'+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"id_str",hash:{},data:e}):d))+'">\r\n'+(null!=(b=c["if"].call(a,null!=a?a.sentKey:a,{name:"if",hash:{},fn:f.program(6,e,0),inverse:f.program(9,e,0),data:e}))?b:"")+'\t\t</div>\r\n\t</div>\r\n\t<div id="friendPublicKeyDetails_'+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?
d:c.helperMissing,"function"===typeof d?d.call(a,{name:"id_str",hash:{},data:e}):d))+'" style="padding:0.5em 0">\r\n'+(null!=(b=c["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:f.program(14,e,0),inverse:f.noop,data:e}))?b:"")+"\t</div>\r\n\t</div>\t\t\r\n"},1:function(f,a,c,g,e){var b,d;return'\t\t\t<span style="font-weight:bold;">'+f.escapeExpression((d=null!=(d=c.screen_name||(null!=a?a.screen_name:a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"screen_name",hash:{},data:e}):
d))+"</span> last sent "+f.escapeExpression((c.tweetShortDate||a&&a.tweetShortDate||c.helperMissing).call(a,null!=(b=null!=a?a.most_recent:a)?b.created_at:b,{name:"tweetShortDate",hash:{},data:e}))+"\r\n"+(null!=(b=c["if"].call(a,null!=a?a.newMessages:a,{name:"if",hash:{},fn:f.program(2,e,0),inverse:f.noop,data:e}))?b:"")+"\t\t\t<br/>\r\n\t\t\t<a href=\"javascript:app.toggleFriendMessages('"+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?d:c.helperMissing,"function"===typeof d?d.call(a,
{name:"id_str",hash:{},data:e}):d))+'\',this.id)" id="friendMessagesToggleLink_'+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"id_str",hash:{},data:e}):d))+'">show conversation</a> (<span id="messageCount_'+f.escapeExpression((d=null!=(d=c.id_str||(null!=a?a.id_str:a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"id_str",hash:{},data:e}):d))+'">'+f.escapeExpression((d=null!=(d=c.message_count||(null!=a?a.message_count:
a))?d:c.helperMissing,"function"===typeof d?d.call(a,{name:"message_count",hash:{},data:e}):d))+"</span>)\r\n"},2:function(f,a,c,g,e){var b;return'\t\t\t\t\t<i class="fa fa-comments msgCount'+f.escapeExpression((b=null!=(b=c.newMessageCount||(null!=a?a.newMessageCount:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"newMessageCount",hash:{},data:e}):b))+'" aria-hidden="true" style="font-size:1.5em" id="newMessagesStatus_'+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:
c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+'"></i>\r\n'},4:function(f,a,c,g,e){var b;return"\t\t\tNo Seecret messages from "+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+" \r\n"},6:function(f,a,c,g,e){var b;return null!=(b=c.unless.call(a,null!=a?a.publicKey:a,{name:"unless",hash:{},fn:f.program(7,e,0),inverse:f.noop,data:e}))?b:""},7:function(f,
a,c,g,e){var b;return'\t\t\t\t\x3c!-- user has sent their key to this follower but has not received a public key in return.  TODO:  make this a key request --\x3e\r\n\t\t\t\t<input type=button value="Invite '+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+'" onClick="app.keyRequest('+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?
b.call(a,{name:"id_str",hash:{},data:e}):b))+')"/>\r\n\t\t\t\t(You may be seeing this because you are using a new mirror site or a different device.  Read more in the <a href="https://www.seecret.net/faq.html" target="_new">FAQ</a>) \r\n'},9:function(f,a,c,g,e){var b;return null!=(b=c["if"].call(a,null!=a?a.publicKey:a,{name:"if",hash:{},fn:f.program(10,e,0),inverse:f.program(12,e,0),data:e}))?b:""},10:function(f,a,c,g,e){var b;return"\t\t\t\t\x3c!-- user has received this follower's public key but has not sent their own public key in response --\x3e\r\n\t\t\t\t<br/>"+
f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+' wants to message you with Seecret.  <input type=button value="Allow" onClick="app.invite('+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+',true)"/>\r\n'},12:function(f,a,c,g,e){var b;return'\t\t\t\t\x3c!-- user has not sent or received public keys with this follower --\x3e\r\n\t\t\t\t<input type=button value="Invite '+
f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+'" onClick="app.invite('+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+')"/>.  \r\n\t\t\t\t<br/>You can send '+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",
hash:{},data:e}):b))+" messages once they accept your invite\r\n"},14:function(f,a,c,g,e){var b;return'\t\t<div id="friendMessageForm_'+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+'" style="display:none">\r\n\t\t\t<textarea id="directMessage_'+f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+'" class="dmField"></textarea>\r\n\t\t\t<input type=button onClick="app.prepareDirectMessage(\''+
f.escapeExpression((b=null!=(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+'\')" value="Send message" class="button" />\r\n\t\t\t<br/>Not sure if '+f.escapeExpression((b=null!=(b=c.screen_name||(null!=a?a.screen_name:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"screen_name",hash:{},data:e}):b))+' has been allowed to message you?  <input type=button class="button" onClick="app.invite('+f.escapeExpression((b=null!=
(b=c.id_str||(null!=a?a.id_str:a))?b:c.helperMissing,"function"===typeof b?b.call(a,{name:"id_str",hash:{},data:e}):b))+',true)" value="Allow"/>\r\n\t\t</div>\r\n'},useData:!0})})();
